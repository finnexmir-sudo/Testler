...
4-cu sinfin qalan fennleri ucun platforma banki -> db/17_bank_sinif4.sql
    ...
    Azerbaycan dili 4   8 movzu x 30 = 240
    Heyat bilgisi 4     5 movzu x 20 = 100
    Informatika 4       5 movzu x 20 = 100
                                cemi  440
...
ELAVE30 = {
"az-4-isim-hallari": [
 ("Yönlük halda olan sözü seçin.",
  "-ə şəkilçisi yönlük haldır: evə.",
  ["Evə", "Evdə", "Evdən", "Evin"], 1, None, 1),
 ("«Kimin?» sualı ismin hansı halına aiddir?",
  "Yiyəlik hal kimin? nəyin? suallarına cavab verir.",
  ["Yiyəlik hala", "Adlıq hala", "Yerlik hala", "Təsirlik hala"],
  1, None, 2),
 ("Adlıq halda olan isim hansı sualla soruşulur?",
  "Adlıq hal: kim? nə? hara?",
  ["Kim? Nə?", "Kimə? Nəyə?", "Kimdə? Nədə?", "Kimdən? Nədən?"],
  1, None, 1),
 ("«Meşədən odun gətirdilər» cümləsində «meşədən» hansı haldadır?",
  "-dən şəkilçisi çıxışlıq haldır.",
  ["Çıxışlıq halda", "Yönlük halda", "Yerlik halda",
   "Adlıq halda"], 1, None, 2),
 ("Halların sırasında adlıqdan sonra hansı hal gəlir?",
  "Sıra: adlıq, yiyəlik, yönlük...",
  ["Yiyəlik hal", "Təsirlik hal", "Yerlik hal", "Çıxışlıq hal"],
  1, None, 3),
 ("«Suyu» sözü («Suyu içdim») hansı haldadır?",
  "Nəyi içdim? — təsirlik hal.",
  ["Təsirlik halda", "Adlıq halda", "Yönlük halda",
   "Çıxışlıq halda"], 1, None, 2),
 ("Yerlik halda olan söz hansı suala cavab verir?",
  "Yerlik hal: kimdə? nədə? harada?",
  ["Harada?", "Haraya?", "Haradan?", "Nə vaxt?"], 1, None, 2),
 ("«Şagirdə» sözündəki «-ə» şəkilçisi hansı halı göstərir?",
  "-a, -ə yönlük halın şəkilçisidir.",
  ["Yönlük halı", "Yiyəlik halı", "Yerlik halı", "Adlıq halı"],
  1, None, 2),
 ("Çıxışlıq halın şəkilçiləri hansılardır?",
  "Çıxışlıq hal: -dan, -dən.",
  ["-dan, -dən", "-da, -də", "-a, -ə", "-ı, -i"], 1, None, 2),
 ("«Torpağın qoxusu» birləşməsində «torpağın» hansı haldadır?",
  "Nəyin qoxusu? — yiyəlik hal.",
  ["Yiyəlik haldadır", "Adlıq haldadır", "Yönlük haldadır",
   "Yerlik haldadır"], 1, None, 3),
],
"az-4-metn-novleri": [
 ("Hadisəni nağıl edən mətnin cümlələrində çox işlənən nitq hissəsi hansıdır?",
  "Hadisələr fellərlə danışılır.",
  ["Fel", "Sifət", "Say", "Nida"], 1, None, 3),
 ("Şeirin sətirləri necə adlanır?",
  "Şeirin hər sətri misradır.",
  ["Misra", "Abzas", "Cümlə üzvü", "Başlıq"], 1, None, 2),
 ("«Dovşan qorxaq heyvandır. Qulaqları uzun, quyruğu qısadır.» Bu parça hansı mətn növüdür?",
  "Əlamətlər sadalanır — təsviridir.",
  ["Təsviri mətn", "Nağıl", "Mühakimə", "Məktub"], 1, None, 2),
 ("Məsələni izah edib «çünki» ilə səbəb göstərən mətn hansı növdəndir?",
  "Səbəb-sübut mühakimə mətnidir.",
  ["Mühakimə mətni", "Təsviri mətn", "Şeir", "Elan"],
  1, None, 3),
 ("Nağıllar adətən hansı sözlərlə bitir?",
  "Nağılın sonunda ənənəvi ifadə işlənir.",
  ["«Göydən üç alma düşdü…»", "«Biri var idi…»",
   "«Əziz dostum…»", "«Hörmətlə…»"], 1, None, 2),
 ("Tapmacada cavab necə verilir?",
  "Tapmacanın cavabı gizli olur, tapmaq lazımdır.",
  ["Gizli saxlanılır", "Əvvəlcədən deyilir", "Yazılı verilir",
   "Şəkillə göstərilir"], 1, None, 2),
 ("Yanıltmac nə üçün deyilir?",
  "Yanıltmac tələffüzü məşq etdirir.",
  ["Düzgün tələffüzü məşq etmək üçün", "Yatmaq üçün",
   "Hesab öyrənmək üçün", "Rəsm çəkmək üçün"], 1, None, 2),
 ("Hekayənin qəhrəmanı kimdir?",
  "Qəhrəman hadisələrin iştirakçısıdır.",
  ["Hadisələrin iştirakçısı", "Kitabın müəllifi", "Oxucu",
   "Nəşriyyat"], 1, None, 2),
 ("Elmi mətn ilə bədii mətni nə fərqləndirir?",
  "Elmi mətn fakt, bədii mətn obraz verir.",
  ["Elmi mətn dəqiq faktlar verir", "Elmi mətn qafiyəli olur",
   "Bədii mətn yalnız rəqəmlərdən ibarətdir",
   "Heç bir fərq yoxdur"], 1, None, 3),
 ("Laylalar (beşik nəğmələri) hansı yaradıcılığa aiddir?",
  "Laylalar xalq yaradıcılığıdır.",
  ["Şifahi xalq yaradıcılığına", "Elmi yaradıcılığa",
   "Rəsm sənətinə", "Memarlığa"], 1, None, 2),
],
"az-4-sifet-dereceleri": [
 ("Hansı sifət çoxaltma dərəcəsindədir: ağappaq, yoxsa ağımtıl?",
  "Ağappaq əlaməti gücləndirir.",
  ["Ağappaq", "Ağımtıl", "İkisi də", "Heç biri"], 1, None, 2),
 ("«Daha hündür» birləşməsindəki «daha» sözü nəyi bildirir?",
  "Daha sözü müqayisə bildirir.",
  ["Müqayisəni", "İnkarı", "Zamanı", "Sıranı"], 1, None, 2),
 ("«Qaraşın» sifəti hansı dərəcəyə aiddir?",
  "-şın şəkilçisi azaltma bildirir.",
  ["Azaltma dərəcəsinə", "Çoxaltma dərəcəsinə", "Adi dərəcəyə",
   "Heç bir dərəcəyə"], 1, None, 3),
 ("Adi dərəcə ilə çoxaltma dərəcəsini necə ayırd edirik?",
  "Çoxaltmada əlamət adi haldan güclüdür.",
  ["Çoxaltmada əlamət güclənir", "Adi dərəcədə əlamət güclənir",
   "Fərq yoxdur", "Çoxaltmada söz qısalır"], 1, None, 3),
 ("«Sapsarı yarpaq» birləşməsində sifət hansı dərəcədədir?",
  "Sapsarı — çoxaltma dərəcəsidir.",
  ["Çoxaltma dərəcəsində", "Azaltma dərəcəsində",
   "Adi dərəcədə", "Sifət deyil"], 1, None, 2),
 ("«-ımtıl, -umtul» şəkilçiləri sifətə hansı çalar verir?",
  "Bu şəkilçilər əlaməti azaldır.",
  ["Azaltma çaları", "Çoxaltma çaları", "İnkar çaları",
   "Zaman çaları"], 1, None, 2),
 ("«Gömgöy» sözündə hansı üsulla dərəcə düzəlib?",
  "İlk heca təkrarlanıb: göm + göy.",
  ["İlk hissənin təkrarı ilə", "Şəkilçi ilə", "Ayrıca sözlə",
   "Vurğu ilə"], 1, None, 3),
 ("Sifətin dərəcələri hansılardır?",
  "Sifətin adi, azaltma və çoxaltma dərəcəsi var.",
  ["Adi, azaltma, çoxaltma", "Keçmiş, indiki, gələcək",
   "Tək, cəm", "Adlıq, yiyəlik"], 1, None, 1),
 ("«Şirin» sifətinin azaltma dərəcəsi hansıdır?",
  "-təhər şəkilçisi azaltma düzəldir.",
  ["Şirintəhər", "Şipşirin", "Ən şirin", "Daha şirin"],
  1, None, 3),
 ("Müqayisədə ən üstün əlaməti bildirmək üçün sifətin əvvəlinə hansı söz artırılır?",
  "Ən sözü üstünlük bildirir: ən uca.",
  ["Ən", "Lap az", "Bir", "Nə"], 1, None, 2),
],
"az-4-fel-zamanlari": [
 ("«Danışacaq» feli hansı zamandadır?",
  "-acaq şəkilçisi gələcək zamandır.",
  ["Gələcək zamanda", "Keçmiş zamanda", "İndiki zamanda",
   "Zamansızdır"], 1, None, 1),
 ("II şəxsin təkində olan fel hansıdır?",
  "-san şəkilçisi II şəxsin təkidir: baxırsan.",
  ["Baxırsan", "Baxıram", "Baxır", "Baxırıq"], 1, None, 2),
 ("Sabahkı hərəkəti bildirən fel hansı şəkilçi ilə düzəlir?",
  "Gələcək zaman: -acaq, -əcək.",
  ["-acaq, -əcək", "-dı, -di", "-ır, -ir", "-ma, -mə"],
  1, None, 2),
 ("«Gəlmişəm» feli hansı zamandadır?",
  "-miş şəkilçisi keçmiş zaman bildirir.",
  ["Keçmiş zamanda", "İndiki zamanda", "Gələcək zamanda",
   "Heç bir zamanda"], 1, None, 2),
 ("«Yazmırıq» felində inkarı hansı hissə bildirir?",
  "-mır hissəciyi inkar edir.",
  ["-mır", "-ıq", "yaz-", "Söz inkar deyil"], 1, None, 3),
 ("Hazırda baş verən hərəkəti hansı zaman bildirir?",
  "İndiki zaman hazırkı hərəkəti göstərir.",
  ["İndiki zaman", "Keçmiş zaman", "Gələcək zaman",
   "Heç biri"], 1, None, 1),
 ("«Gördük» feli hansı şəxsdə və hansı zamandadır?",
  "-dük: biz gördük — I şəxs cəm, keçmiş.",
  ["I şəxs cəm, keçmiş", "II şəxs tək, indiki",
   "III şəxs cəm, gələcək", "I şəxs tək, keçmiş"], 1, None, 3),
 ("Felin zamanları hansılardır?",
  "Felin üç zamanı var.",
  ["Keçmiş, indiki, gələcək", "Adi, azaltma, çoxaltma",
   "Tək, cəm", "Adlıq, yönlük, yerlik"], 1, None, 1),
 ("«Uçur» felini keçmiş zamana çevirin.",
  "Uçur — indiki, uçdu — keçmiş.",
  ["Uçdu", "Uçacaq", "Uçmur", "Uçuram"], 1, None, 2),
 ("«Sabah», «dünən» kimi sözlər felin nəyini müəyyən etməyə kömək edir?",
  "Bu sözlər hərəkətin zamanını göstərir.",
  ["Zamanını", "Şəxsini", "İnkarını", "Hecasını"], 1, None, 2),
],
"az-4-evezlik": [
 ("«Mən» və «biz» əvəzliklərini fərqləndirən nədir?",
  "Mən tək, biz cəmdir.",
  ["Tək və cəm olması", "Zamanları", "Halları", "Hecaları"],
  1, None, 2),
 ("«Onun kitabı» birləşməsində əvəzlik hansıdır?",
  "Onun — şəxs əvəzliyidir.",
  ["Onun", "Kitabı", "Hər ikisi", "Heç biri"], 1, None, 1),
 ("Bir neçə adama birlikdə müraciət edəndə hansı əvəzlik işlədilir?",
  "Çox adama siz deyilir.",
  ["Siz", "Mən", "O", "Bu"], 1, None, 2),
 ("«Bu» və «o» sözləri əşyaya görə nəyi bildirir?",
  "Bu — yaxını, o — uzağı göstərir.",
  ["İşarəni", "Zamanı", "Hərəkəti", "Sayı"], 1, None, 2),
 ("Cümlədə təkrarı aradan qaldırmaq üçün ismin yerinə nə işlədilir?",
  "İsmin yerini əvəzlik tutur.",
  ["Əvəzlik", "Fel", "Say", "Nida"], 1, None, 2),
 ("Əşyanı soruşmaq üçün hansı sual əvəzliyi işlədilir?",
  "Əşya nə? sualı ilə soruşulur.",
  ["Nə?", "Kim?", "Necə?", "Nə vaxt?"], 1, None, 2),
 ("«Özüm bacararam» cümləsindəki «özüm» sözü hansı nitq hissəsidir?",
  "Özüm — əvəzlikdir.",
  ["Əvəzlikdir", "Feldir", "İsimdir", "Saydır"], 1, None, 3),
 ("«Aysel və Nərmin gəldilər. … birlikdə oxuyurlar.» Nöqtələrin yerinə hansı əvəzlik uyğundur?",
  "İki nəfər — onlar.",
  ["Onlar", "Mən", "Sən", "Biz"], 1, None, 2),
 ("Söhbətdə danışan şəxs özünü hansı əvəzliklə göstərir?",
  "Danışan özünə mən deyir.",
  ["Mən", "Sən", "O", "Onlar"], 1, None, 1),
 ("«Sənin dəftərin» birləşməsindəki əvəzlik hansı şəxsə aiddir?",
  "Sənin — II şəxsdir.",
  ["II şəxsə", "I şəxsə", "III şəxsə", "Heç bir şəxsə"],
  1, None, 2),
],
"az-4-cumle-uzvleri": [
 ("«Bağban ağacları suladı» cümləsində mübtəda hansıdır?",
  "Kim suladı? — bağban.",
  ["Bağban", "Ağacları", "Suladı", "Mübtəda yoxdur"], 1, None, 1),
 ("«Payızda yarpaqlar saralır» cümləsində xəbər hansıdır?",
  "Nə edir? — saralır.",
  ["Saralır", "Payızda", "Yarpaqlar", "Xəbər yoxdur"],
  1, None, 1),
 ("İkinci dərəcəli üzvlər cümləyə nə verir?",
  "Onlar fikri dəqiqləşdirib genişləndirir.",
  ["Fikri genişləndirir", "Fikri qısaldır", "Səhv əlavə edir",
   "Heç nə vermir"], 1, None, 2),
 ("«Nə edir?», «nə etdi?» sualları hansı üzvün suallarıdır?",
  "Hərəkət sualları xəbərə verilir.",
  ["Xəbərin", "Mübtədanın", "Bütün üzvlərin", "Heç birinin"],
  1, None, 2),
 ("«Quş oxuyur» cümləsinə hansı sözü əlavə etsək geniş cümlə alınar?",
  "Yer bildirən söz cümləni genişləndirir.",
  ["Budaqda", "Və", "Amma", "Bəli"], 1, None, 3),
 ("«Dənizdə gəmilər üzürdü» cümləsində «dənizdə» sözü nəyi bildirir?",
  "Harada üzürdü? — yeri bildirir.",
  ["Hərəkətin yerini", "Hərəkətin vaxtını", "Əşyanın rəngini",
   "Hərəkətin səbəbini"], 1, None, 2),
 ("Qrammatik əsas nədir?",
  "Qrammatik əsas baş üzvlərdir.",
  ["Mübtəda ilə xəbər", "Bütün sözlər", "Yalnız isimlər",
   "Durğu işarələri"], 1, None, 2),
 ("«Qardaşım həkimdir» cümləsində xəbər nə ilə ifadə olunub?",
  "Həkimdir — isimlə ifadə olunmuş xəbərdir.",
  ["İsimlə", "Fellə", "Sayla", "Əvəzliklə"], 1, None, 3),
 ("«Səhər açıldı» cümləsi müxtəsərdir, yoxsa geniş?",
  "Yalnız baş üzvlərdən ibarət cümlə müxtəsərdir.",
  ["Müxtəsərdir", "Genişdir", "Cümlə deyil", "Sualdır"],
  1, None, 3),
 ("Cümlə üzvləri sırasında mübtəda adətən harada durur?",
  "Mübtəda adətən cümlənin əvvəlində olur.",
  ["Əvvəldə", "Sonda", "Ortada", "Cümlədən kənarda"],
  1, None, 2),
],
"az-4-durgu": [
 ("Üç nöqtə (…) nəyi bildirir?",
  "Üç nöqtə fikrin yarımçıq qaldığını göstərir.",
  ["Fikrin yarımçıq qaldığını", "Sualı", "Sevinci", "Əmri"],
  1, None, 2),
 ("«Salam əziz dostum» müraciətində vergül hara qoyulmalıdır?",
  "Müraciətdən əvvəlki sözdən sonra: Salam, əziz dostum.",
  ["«Salam»dan sonra", "«Əziz»dən sonra", "«Dostum»dan sonra",
   "Vergül lazım deyil"], 1, None, 3),
 ("Hansı cümlə nəqli cümlədir?",
  "Məlumat verən cümlə nəqlidir və nöqtə ilə bitir.",
  ["Payız gəldi.", "Payız gəldimi?", "Nə gözəl payız!",
   "Tez gəl!"], 1, None, 2),
 ("«Oxu, öyrən, yarat» sözləri arasındakı vergüllər nəyi göstərir?",
  "Sadalanan sözlər vergüllə ayrılır.",
  ["Sadalanmanı", "Sualı", "Cümlənin sonunu", "İnkarı"],
  1, None, 2),
 ("Kitabın adı mətn içində hansı işarələrlə göstərilir?",
  "Adlar dırnaq içində yazılır.",
  ["Dırnaq işarələri ilə", "Mötərizə ilə", "Nöqtə ilə",
   "Tire ilə"], 1, None, 2),
 ("Sevinc bildirən cümlənin sonunda adətən hansı işarə olur?",
  "Hiss-həyəcan nida işarəsi ilə bitir.",
  ["Nida (!) işarəsi", "Vergül", "İki nöqtə", "Defis"],
  1, None, 1),
 ("Dialoqda hər replika hansı sətirdən yazılır?",
  "Hər danışan yeni sətirdən başlayır.",
  ["Yeni sətirdən", "Eyni sətirdən", "Səhifə sonundan",
   "Kənar sütundan"], 1, None, 2),
 ("«Dur, get!» cümləsi hansı məqsədlə deyilir?",
  "Bu cümlə əmr bildirir.",
  ["Əmr məqsədi ilə", "Məlumat vermək üçün", "Sual üçün",
   "Təsvir üçün"], 1, None, 2),
 ("Məqsədinə görə cümlə hansı dörd növə bölünür?",
  "Cümlələr nəqli, sual, əmr və nida olur.",
  ["Nəqli, sual, əmr, nida", "Tək, cəm", "Adi, çoxaltma",
   "Keçmiş, indiki, gələcək"], 1, None, 2),
 ("Vergül oxunuşda özünü necə göstərir?",
  "Vergüldə qısa fasilə edilir.",
  ["Qısa fasilə ilə", "Uzun sükutla", "Səsin ucalması ilə",
   "Heç cür"], 1, None, 3),
],
"az-4-insa": [
 ("İnşa planı yazıya nə verir?",
  "Plan fikirlərin ardıcıllığını qoruyur.",
  ["Ardıcıllıq", "Səhv", "Uzunluq", "Şəkil"], 1, None, 2),
 ("«Bənövşə» sözü neçə hecadan ibarətdir?",
  "Bə-növ-şə — üç heca.",
  ["Üç hecadan", "İki hecadan", "Dörd hecadan", "Beş hecadan"],
  1, None, 2),
 ("Kiməsə minnətdarlıq bildirmək üçün hansı məktub yazılır?",
  "Minnətdarlıq təşəkkür məktubunda bildirilir.",
  ["Təşəkkür məktubu", "Şikayət məktubu", "Dəvətnamə",
   "Elan"], 1, None, 2),
 ("İnşada mövzudan kənara çıxmaq necə qiymətləndirilir?",
  "Mövzudan kənara çıxmaq qüsurdur.",
  ["Səhv sayılır", "Təqdirəlayiqdir", "Vacibdir",
   "Qiymətə təsir etmir"], 1, None, 2),
 ("«Dostluq» mövzusunda inşaya hansı atalar sözü epiqraf ola bilər?",
  "Atalar sözü mövzuya uyğun seçilir.",
  ["Dost dar gündə tanınar", "Az danış, düz danış",
   "Tez duran yol alar", "Su axar, çuxurunu tapar"], 1, None, 3),
 ("Yazı zamanı hər abzas necə başlanır?",
  "Abzas yeni sətirdən, kiçik boşluqla başlanır.",
  ["Yeni sətirdən, boşluqla", "Sətrin ortasından",
   "Böyük şəkillə", "Rəqəmlə"], 1, None, 2),
 ("Qar, şaxta və qış oyunları hansı mövzunun inşasına uyğundur?",
  "Bunlar qış mövzusuna aiddir.",
  ["«Qış» mövzusuna", "«Yay» mövzusuna", "«Kosmos» mövzusuna",
   "«Dəniz» mövzusuna"], 1, None, 1),
 ("Hüsnxətlə yazının faydası nədir?",
  "Səliqəli yazı asan oxunur.",
  ["Yazı aydın oxunur", "Yazı uzun olur", "Səhvlər artır",
   "Vaxt itirilir"], 1, None, 2),
 ("Məktubu kim imzalayır?",
  "Məktubun sonunda yazan imza qoyur.",
  ["Yazan şəxs", "Poçtalyon", "Oxuyan şəxs", "Müəllim"],
  1, None, 1),
 ("Yazıda abzasların olması oxucuya nə verir?",
  "Abzaslar mətni hissələrə ayırıb oxunuşu asanlaşdırır.",
  ["Mətni asan oxumaq imkanı", "Sözlərin sayını",
   "Səhvlərin sayını", "Heç nə"], 1, None, 3),
],
}
