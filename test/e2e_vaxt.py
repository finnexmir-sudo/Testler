...
with sync_playwright() as p:
    ...
    ok(t.locator("#pLim").input_value() == "0", "susmaya gore vaxtsiz")
    t.select_option("#pLim", "5"); t.wait_for_selector(".paper", timeout=15000); t.wait_for_timeout(600)
    ...
    ok(t.locator("#pLim").input_value() == "5", "secim yeniden acilanda qalir")
