...
with sync_playwright() as pw:
    ...
    #  «Girişə qayıt» islemelidir (17.09: hadise yazilmamisdi, duyme olu idi)
    pg.click("#btnFgBack"); pg.wait_for_selector("#btnAuth", timeout=4000)
    ok(pg.locator("#fgMail").count() == 0 and pg.locator("#btnAuth").count() == 1, "«Girişə qayıt» giris ekranina qaytarir")
    pg.click("#btnForgot"); pg.wait_for_selector("#fgMail", timeout=4000)
