--  216: TEZE SAGIRD «SUSAN» SAYILMIR
--
--  Muellim qeydiyyatdan kecir, uc sagird elave edir, Icmala qayidir -
--  kart deyir: «3 nefer bir heftedir sessizdir».  Sagirdler bes
--  deqiqelikdir ki var.  Ilk gunun ilk cumlesi tohmet olurdu.
--
--  Sayim indi YALNIZ bir hefteden artiq movcud olan sagirdi goturur.
--  Basqa hec ne deyismir - funksiyanin tam govdesi asagida (marker
--  usulu artiq islenmir).
