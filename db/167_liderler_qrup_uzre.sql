-- =====================================================================
--  167_liderler_qrup_uzre.sql — "EN YAXSI SAGIRDLER" HER QRUPUN ICINDE
--
--  Istifadeci mushahidesi (163 tetbiq olunandan sonra): siyahida
--  "Fazil xalaoglu" ve "Ev qrup" sagirdleri yan-yana dusur.
--
--  Problem: qruplar FERQLI test yazir.  3-cu sinif qrupunun testi ile
--  11-ci sinif DIM qrupunun testi eyni cetinlikde deyil, ona gore
--  onlarin faizini yan-yana qoymaq siralama kimi MENASIZDIR.  Ustelik
--  ededalitsizdir: asan qrupdaki sagird hemise birinci olur, cetin
--  qrupda en cox ireliliyen ise siyahiya hec vaxt dusmur.  Muellim
--  bunu gorur ve bolmeye inanmir.
--
--  Hell: siralama HER QRUPUN ICINDE aparilir (row_number partition by
--  class_id).  Panel qrup cipi ile birini gosterir.  Cipde "Hamisi"
--  YOXDUR - siyahi muqayisedir, "hamisi" mehz yanlis olan seydir.
--
--  Qrupsuz sagird siyahiya dusmur: muqayise uchun konteksti yoxdur
--  (ustelik #/s/<id>/<qrup> marsrutu qrup id-si teleb edir).
--
--  163-un ustune yazilir, basqa hec ne deyismir.
-- =====================================================================
...
do $$ begin
  raise notice '167 OK - "top" artiq HER QRUPUN oz ilk 5 sagirdini qaytarir.';
end $$;
