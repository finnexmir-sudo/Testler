-- =====================================================================
--  muellim_istifade.sql : BIR MUELLIM proqramin hansi imkanlarindan
--  istifade edir?
--
--  NIYE
...
--  Netice: her imkan ucun bir setir - islədirmi, nece defe, en son ne
--  vaxt.  ISLETMEDIYI setirler YUXARIDA cixir - mesaj movzusu odur.
--
