...
for f in 11_sual_banki.sql 12_bank_rpc.sql 13_generator.sql 14_movzular.sql \
         ...
         122_bio11_insan_muhit_duzelis.sql \
         123_tarix11_mustemleke_cenub.sql \
         124_inf11_komputer_veb_duzelis.sql \
         125_kim11_aldehid_izomer.sql \
         ...
         137_inf10_informasiya_miqdari.sql \
         138_inf11_modellesdirme_bosluqlar.sql \
