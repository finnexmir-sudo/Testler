...
for f in 11_sual_banki.sql 12_bank_rpc.sql 13_generator.sql 14_movzular.sql \
         ...
         20_bank_sinif3.sql \
         08_reports.sql 18_siqnal.sql 21_paket.sql 22_esas.sql 23_bildiris.sql 24_admin_2fa.sql 25_ders_plani.sql 26_fenn.sql 27_hesabat.sql 28_ferdi_tapsiriq.sql 29_bank_katalog.sql 100_seviyye_modeli.sql 101_ders_plani_alt.sql 05_grants.sql; do
  printf "  %-22s" "$f"
