...
--  1 · susmaya gore tam olaraq 26 funksiya aciqdir
--      (212: +2 gundelik tekrar · 901: +rpc_demo_gc)
do $$
...
begin
  ...
  if v_say <> 26 then
    raise exception 'anon % funksiya gorur (26 gozlenilir): %', v_say, v_ad;
  end if;
end $$;
\echo 'OK  1 · anon tam olaraq 26 RPC gorur'
