...
--
--  12 movzu x 10 sual = 120.  ext_key: riy3-<movzu>#<sira>.
...
('riy3-ifade-tenlik#4','riy-3-ifade-tenlik',2,2,'(45 − 15) : 5 ifadəsinin qiyməti neçədir?','Əvvəl mötərizə: 45 − 15 = 30; sonra 30 : 5 = 6.',array['6','30','42','12'],1),
...
('riy3-vurma-bolme-2#3','riy-3-vurma-bolme-2',2,3,'96 : 3 qismətini tapın.','96 : 3 = 32.',array['32','31','33','23'],1),
...
begin
  ...
  if n <> 120 then
    raise exception 'riy3 suallari: 120 gozlenilirdi, % tapildi', n;
  end if;
