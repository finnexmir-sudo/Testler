-- =====================================================================
--  162_ziyaret_huni.sql — HUNIDE QEYDIYYAT YALNIZ SAYGAC BASLAYANDAN
--
--  Canli ilk gun (2026-09-08): "1 unikal ziyaretci -> 4 qeydiyyat (400%)".
--  Qeydiyyatlar saygacdan EVVEL acilmis hesablar idi.  Indi qeydiyyat
--  yalniz ilk ziyaret setrinden sonra sayilir (app.visit_start()):
--  huni ziyaret->demo->qeydiyyat eyni dovru olcsun.
-- =====================================================================

create or replace function app.visit_start() returns date
language sql stable security definer set search_path = public, extensions, pg_temp as $$
  select coalesce((select min(at)::date from public.visits), current_date)
$$;
revoke all on function app.visit_start() from public, anon, authenticated;
