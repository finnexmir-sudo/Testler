...
('az4-sifet-dereceleri#1','az-dili','az-4-sifet-dereceleri',1,2,'Sifət nəyi bildirir?','Sifət əşyanın əlamətini bildirir: necə? nə cür? hansı?',array['Əşyanın əlamətini','Hərəkəti','Miqdarı','Əşyanın adını'],1),
...
('az4-sifet-dereceleri#10','az-dili','az-4-sifet-dereceleri',3,2,'«Daha güclü» birləşməsi sifətin hansı dərəcəsini bildirir?','«Daha» sözü ilə əlamətin çoxluğu — çoxaltma dərəcəsi bildirilir.',array['Çoxaltma','Azaltma','Adi','Heç biri'],1),
('az4-fel-zamanlari#1','az-dili','az-4-fel-zamanlari',1,2,'Fel nəyi bildirir?','Fel hərəkəti bildirir: nə edir? nə etdi? nə edəcək?',array['Hərəkəti','Əlaməti','Miqdarı','Əşyanın adını'],1),
('az4-fel-zamanlari#2','az-dili','az-4-fel-zamanlari',1,2,'Felin neçə zamanı var?','Felin üç zamanı var: keçmiş, indiki, gələcək.',array['3','2','4','5'],1),
...
('az4-fel-zamanlari#10','az-dili','az-4-fel-zamanlari',3,2,'Hansı söz feldir?','Fellər «nə etmək?» sualına cavab verir: qaçmaq.',array['qaçmaq','qaçış','cəld','yol'],1),
...
('az4-cumle-uzvleri#1','az-dili','az-4-cumle-uzvleri',1,3,'Cümlənin baş üzvləri hansılardır?','Cümlənin baş üzvləri mübtəda və xəbərdir.',array['Mübtəda və xəbər','İsim və fel','Söz və heca','Sual və nida'],1),
...
('az4-durgu#4','az-dili','az-4-durgu',2,4,'Sadalanan üzvlər arasında hansı işarə qoyulur?','Sadalanan sözlər vergüllə ayrılır.',array['Vergül','Nöqtə','Tire','Sual işarəsi'],1),
...
('az4-insa#3','az-dili','az-4-insa',1,4,'Hansı söz həmişə böyük hərflə yazılır?','Xüsusi isimlər — şəhər, insan, çay adları — böyük hərflə yazılır.',array['Bakı','kitab','məktəb','ağac'],1),
...
('az4-insa#6','az-dili','az-4-insa',2,4,'Hansı sözü sətirdən sətrə keçirmək olmaz?','Birhecalı sözlər sətirdən sətrə keçirilmir.',array['dağ','kitab','dəftər','məktəb'],1),
...
('inf4-kompyuter#8','informatika','inf-4-kompyuter',2,3,'Kompüterdə şəkil çəkmək üçün hansı proqramdan istifadə olunur?','Qrafik redaktorda (məsələn, Paint) şəkil çəkilir.',array['Qrafik redaktor (Paint)','Kalkulyator','Saat','Musiqi pleyeri'],1),
