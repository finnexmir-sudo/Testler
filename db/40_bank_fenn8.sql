...
--  = 28 movzu x 20 = 560.  ext_key: fiz8-/kim8-/bio8-/cog8-...
...
('fiz8-quvve#11','fizika','fiz-8-quvve',2,1,'Kütləsi 12 kq olan çantanın ağırlıq qüvvəsi neçə nyutondur? (g = 10 N/kq)','F = m·g = 12 · 10 = 120 N.',array['120 N','12 N','22 N','1200 N'],1),
('fiz8-quvve#12','fizika','fiz-8-quvve',3,1,'Sərtliyi 400 N/m olan yay 0,05 m sıxılıb. Elastiklik qüvvəsi neçədir?','F = k·x = 400 · 0,05 = 20 N.',array['20 N','8 N','400 N','2 N'],1),
('fiz8-quvve#13','fizika','fiz-8-quvve',3,1,'Qüvvənin təsiri nədən asılıdır?','Qiymətindən, istiqamətindən və tətbiq nöqtəsindən.',array['Qiymətindən, istiqamətindən, tətbiq nöqtəsindən','Yalnız rəngindən','Havadan','Cismin adından'],1),
('fiz8-quvve#14','fizika','fiz-8-quvve',2,1,'Sürtünməni azaltmaq üçün nə edilir?','Səthlər yağlanır, hamarlanır.',array['Səthlər yağlanır','Səthlər qumlanır','Yük artırılır','Səthlər qurudulur'],1),
('fiz8-quvve#15','fizika','fiz-8-quvve',3,1,'Sürtünmə faydalı ola bilərmi?','Bəli — yerimək, əyləc üçün lazımdır.',array['Bəli, yerimək üçün lazımdır','Xeyr, həmişə zərərlidir','Yalnız qışda','Yalnız maşınlarda'],1),
('fiz8-quvve#16','fizika','fiz-8-quvve',3,1,'Cismin çəkisi ilə kütləsi eyni anlayışdırmı?','Xeyr — çəki qüvvədir, kütlə maddə miqdarıdır.',array['Xeyr, fərqli anlayışlardır','Bəli, eynidir','Yalnız Yerdə eynidir','Heç biri ölçülmür'],1),
('fiz8-quvve#17','fizika','fiz-8-quvve',3,1,'Dinamometrin əsas hissəsi nədir?','Dərəcələnmiş yaydır.',array['Dərəcələnmiş yay','Maqnit','Linza','Civə sütunu'],1),
('fiz8-quvve#18','fizika','fiz-8-quvve',3,1,'İki qüvvə: 8 N şərqə, 8 N qərbə təsir edir. Əvəzləyici neçədir?','Bərabər əks qüvvələr tarazlaşır: 0 N.',array['0 N','16 N','8 N','64 N'],1),
('fiz8-quvve#19','fizika','fiz-8-quvve',3,1,'Deformasiyanın növləri hansılardır?','Elastik (bərpa olunan) və plastik (qalan).',array['Elastik və plastik','İsti və soyuq','Sürətli və yavaş','Böyük və balaca yalnız'],1),
('fiz8-quvve#20','fizika','fiz-8-quvve',2,1,'Ağırlıq qüvvəsi hansı istiqamətdə yönəlir?','Şaquli olaraq aşağı — Yerin mərkəzinə.',array['Şaquli aşağı','Üfüqi','Yuxarı','İxtiyari'],1),
...
('fiz8-is-enerji#11','fizika','fiz-8-is-enerji',2,1,'Kütləsi 2 kq olan cisim 5 m hündürlükdədir. Potensial enerjisi neçədir? (g = 10)','E = m·g·h = 2 · 10 · 5 = 100 J.',array['100 J','10 J','50 J','1000 J'],1),
('fiz8-is-enerji#12','fizika','fiz-8-is-enerji',3,1,'Güc vahidi hansı alimin şərəfinə adlandırılıb?','Buxar maşınını təkmilləşdirən Ceyms Uattın.',array['Ceyms Uattın','Nyutonun','Paskalın','Culun'],1),
('fiz8-is-enerji#13','fizika','fiz-8-is-enerji',2,1,'1 kilovatt neçə vattdır?','1 kVt = 1000 Vt.',array['1000 Vt','100 Vt','10 Vt','60 Vt'],1),
('fiz8-is-enerji#14','fizika','fiz-8-is-enerji',3,1,'Qüvvə yerdəyişməyə perpendikulyar olduqda görülən iş neçədir?','Bu halda iş sıfırdır.',array['Sıfırdır','Maksimumdur','Mənfidir hökmən','Hesablanmır'],1),
('fiz8-is-enerji#15','fizika','fiz-8-is-enerji',3,1,'Tərpənən blok nə qazandırır?','Qüvvədə iki dəfə qazanc verir.',array['Qüvvədə iki dəfə qazanc','Yolda qazanc','Zamanla qazanc','Heç nə'],1),
('fiz8-is-enerji#16','fizika','fiz-8-is-enerji',2,1,'800 J iş 20 saniyəyə görülür. Güc neçə vattdır?','P = 800 : 20 = 40 Vt.',array['40 Vt','820 Vt','16000 Vt','4 Vt'],1),
('fiz8-is-enerji#17','fizika','fiz-8-is-enerji',2,1,'Enerji hansı vahidlə ölçülür?','Enerji də iş kimi coulla ölçülür.',array['Coulla','Nyutonla','Amperlə','Metrlə'],1),
('fiz8-is-enerji#18','fizika','fiz-8-is-enerji',2,1,'Sıxılmış yayın enerjisi hansı enerjidir?','Vəziyyət enerjisi — potensialdır.',array['Potensial enerji','Kinetik enerji','İstilik yalnız','Səs enerjisi'],1),
('fiz8-is-enerji#19','fizika','fiz-8-is-enerji',2,1,'Mexaniki işin görülməsi üçün nə vacibdir?','Qüvvə və onun istiqamətində yerdəyişmə.',array['Qüvvə və yerdəyişmə','Yalnız zaman','Yalnız kütlə','İşıq'],1),
('fiz8-is-enerji#20','fizika','fiz-8-is-enerji',2,1,'Axan çayın suyu hansı enerjiyə malikdir?','Hərəkət enerjisinə — kinetikə.',array['Kinetik enerjiyə','Yalnız potensiala','Elektrik enerjisinə','Heç birinə'],1),
...
('fiz8-tezyiq#11','fizika','fiz-8-tezyiq',3,2,'Kəsici alətlərin iti saxlanması təzyiqi necə dəyişir?','Sahə kiçildikcə təzyiq artır.',array['Artırır (sahə kiçilir)','Azaldır','Dəyişmir','Sıfırlayır'],1),
('fiz8-tezyiq#12','fizika','fiz-8-tezyiq',3,2,'Traktorların tırtılları nə üçün enli olur?','Sahə böyük — təzyiq az olur, batmır.',array['Təzyiqi azaltmaq üçün','Sürəti artırmaq üçün','Gözəllik üçün','Səs üçün'],1),
('fiz8-tezyiq#13','fizika','fiz-8-tezyiq',2,2,'1 kilopaskal neçə paskaldır?','1 kPa = 1000 Pa.',array['1000 Pa','100 Pa','10 Pa','760 Pa'],1),
('fiz8-tezyiq#14','fizika','fiz-8-tezyiq',2,2,'Dərinlik artdıqca mayenin təzyiqi necə dəyişir?','p = ρgh — dərinliklə artır.',array['Artır','Azalır','Dəyişmir','Sıfır olur'],1),
('fiz8-tezyiq#15','fizika','fiz-8-tezyiq',3,2,'Arximed qüvvəsi nədən asılıdır?','Mayenin sıxlığından və cismin batan həcmindən.',array['Mayenin sıxlığından və cismin həcmindən','Cismin rəngindən','Havanın istiliyindən','Qabın formasından yalnız'],1),
('fiz8-tezyiq#16','fizika','fiz-8-tezyiq',3,2,'Hidravlik pres hansı qanuna əsaslanır?','Paskal qanununa əsaslanır.',array['Paskal qanununa','Om qanununa','Huk qanununa','Nyutonun I qanununa'],1),
('fiz8-tezyiq#17','fizika','fiz-8-tezyiq',3,2,'Suyun 5 m dərinliyində təzyiq neçə kilopaskaldır? (ρ = 1000, g = 10)','p = 1000·10·5 = 50 000 Pa = 50 kPa.',array['50 kPa','5 kPa','500 kPa','15 kPa'],1),
('fiz8-tezyiq#18','fizika','fiz-8-tezyiq',3,2,'Atmosfer təzyiqini ilk dəfə ölçən alim kimdir?','İtalyan alimi Torriçelli.',array['Torriçelli','Nyuton','Arximed','Om'],1),
('fiz8-tezyiq#19','fizika','fiz-8-tezyiq',3,2,'Qazın təzyiqi nədən yaranır?','Molekulların qabın divarlarına zərbələrindən.',array['Molekulların divarlara zərbəsindən','Qazın rəngindən','İşıqdan','Səsdən'],1),
('fiz8-tezyiq#20','fizika','fiz-8-tezyiq',3,2,'Nəhəng dəmir gəmilər niyə batmır?','Arximed qüvvəsi gəminin çəkisini tarazlayır.',array['Arximed qüvvəsi çəkini tarazlayır','Dəmir yüngüldür','Su onları itələmir','Sehrlidir'],1),
...
('fiz8-dalgalar#11','fizika','fiz-8-dalgalar',3,3,'Dalğa yayılarkən mühitin hissəcikləri nə edir?','Yerlərində rəqs edir, dalğa ilə getmir.',array['Yerində rəqs edir','Dalğa ilə birlikdə axır','Dayanır','Yox olur'],1),
('fiz8-dalgalar#12','fizika','fiz-8-dalgalar',3,3,'İnsan qulağı hansı tezlik aralığındakı səsləri eşidir?','16 Hz-dən 20 000 Hz-ə qədər.',array['16–20 000 Hz','1–2 Hz','1 milyon Hz-dən yuxarı','Bütün tezlikləri'],1),
('fiz8-dalgalar#13','fizika','fiz-8-dalgalar',3,3,'Tezliyi 20 000 Hz-dən yüksək səslər necə adlanır?','Ultrasəs adlanır.',array['Ultrasəs','İnfrasəs','Küy','Əks-səda'],1),
('fiz8-dalgalar#14','fizika','fiz-8-dalgalar',2,3,'Ultrasəsdən harada istifadə olunur?','Tibbdə müayinədə (USM).',array['Tibbdə (USM)','Yalnız musiqidə','İşıqlandırmada','İstilikdə'],1),
('fiz8-dalgalar#15','fizika','fiz-8-dalgalar',3,3,'Səs bərk cisimlərdə mayelərə nisbətən necə yayılır?','Daha sürətli yayılır.',array['Daha sürətli','Daha yavaş','Yayılmır','Eyni sürətlə'],1),
('fiz8-dalgalar#16','fizika','fiz-8-dalgalar',3,3,'Periodu 0,1 san olan rəqsin tezliyi neçə hersdir?','ν = 1 : 0,1 = 10 Hz.',array['10 Hz','1 Hz','0,1 Hz','100 Hz'],1),
('fiz8-dalgalar#17','fizika','fiz-8-dalgalar',2,3,'Musiqi alətlərində səsi nə yaradır?','Simlərin, havanın rəqsləri.',array['Simlərin və havanın rəqsi','İşıq','İstilik','Maqnit sahəsi'],1),
('fiz8-dalgalar#18','fizika','fiz-8-dalgalar',2,3,'Səsboğucu materiallar hansı xassəyə malikdir?','Səs dalğalarını udur.',array['Səsi udur','Səsi gücləndirir','Səsi sürətləndirir','İşıq saçır'],1),
('fiz8-dalgalar#19','fizika','fiz-8-dalgalar',3,3,'Şimşəkdən 6 saniyə sonra göy gurultusu eşidilir. Məsafə neçə metrdir? (v = 340 m/s)','S = 340 · 6 = 2040 m.',array['2040 m','340 m','56 m','6000 m'],1),
('fiz8-dalgalar#20','fizika','fiz-8-dalgalar',2,3,'Güclü küy insan sağlamlığına necə təsir edir?','Eşitməni və sinir sistemini zədələyir.',array['Eşitməni və sinirləri zədələyir','Təsir etmir','Yalnız faydalıdır','Görməni yaxşılaşdırır'],1),
...
('fiz8-istilik#11','fizika','fiz-8-istilik',2,3,'İstilikvermə hansı istiqamətdə gedir?','İsti cisimdən soyuq cismə.',array['İsti cisimdən soyuğa','Soyuqdan istiyə','Hər iki istiqamətdə bərabər','Getmir'],1),
('fiz8-istilik#12','fizika','fiz-8-istilik',3,3,'Termosun quruluşu hansı məqsədə xidmət edir?','İstilik ötürülməsinin qarşısını alır.',array['İstilik ötürülməsinin qarşısını alır','İçindəkini soyudur hökmən','Səsi saxlayır','İşığı saxlayır'],1),
('fiz8-istilik#13','fizika','fiz-8-istilik',2,3,'Çaydakı metal qaşıq niyə isinir?','İstilik metalla ötürülür.',array['İstilikkeçirmə ilə','Şüalanma ilə yalnız','Konveksiya ilə yalnız','İsinmir'],1),
('fiz8-istilik#14','fizika','fiz-8-istilik',3,3,'Xüsusi istilik tutumu nəyi göstərir?','1 kq maddəni 1° qızdırmaq üçün lazım olan istiliyi.',array['1 kq maddəni 1° qızdırmaq üçün istiliyi','Cismin ümumi istiliyini','Qaynama nöqtəsini','Ərimə sürətini'],1),
('fiz8-istilik#15','fizika','fiz-8-istilik',3,3,'1 kq suyu 1 °C qızdırmaq üçün nə qədər istilik lazımdır?','Suyun xüsusi istilik tutumu qədər: 4200 J.',array['4200 J','42 J','100 J','1000 J'],1),
('fiz8-istilik#16','fizika','fiz-8-istilik',2,3,'Qızdırılan hava hansı istiqamətdə hərəkət edir?','Yüngülləşib yuxarı qalxır.',array['Yuxarı qalxır','Aşağı enir','Yerində qalır','Yox olur'],1),
('fiz8-istilik#17','fizika','fiz-8-istilik',3,3,'Tünd rəngli səthlər şüalanmanı necə udur?','Açıq rənglilərdən daha yaxşı.',array['Daha yaxşı udur','Udmur','Əks etdirir tam','Şüalanmadan qaçır'],1),
('fiz8-istilik#18','fizika','fiz-8-istilik',3,3,'Yun paltar niyə isti saxlayır?','Liflər arasındakı hava istilikkeçirməni azaldır.',array['Havanı saxlayıb istilikkeçirməni azaldır','Özü istilik yaradır','Günəşdən enerji alır','Sehrlidir'],1),
('fiz8-istilik#19','fizika','fiz-8-istilik',3,3,'3 kq suyu 20 °C qızdırmaq üçün istilik neçə couldur? (c = 4200)','Q = 4200 · 3 · 20 = 252 000 J.',array['252000 J','84 000 J','12 600 J','4 200 J'],1),
('fiz8-istilik#20','fizika','fiz-8-istilik',3,3,'Broun hərəkəti nəyi sübut edir?','Molekulların fasiləsiz hərəkətini.',array['Molekulların hərəkətini','Cisimlərin sükunətini','İşığın düz yayılmasını','Səsin sürətini'],1),
...
('fiz8-istilik-qanun#11','fizika','fiz-8-istilik-qanun',3,4,'Xüsusi ərimə istiliyi nəyi göstərir?','1 kq bərk maddəni əritmək üçün istiliyi.',array['1 kq maddəni əritmək üçün istiliyi','Qaynama temperaturunu','Cismin kütləsini','Sıxlığı'],1),
('fiz8-istilik-qanun#12','fizika','fiz-8-istilik-qanun',3,4,'Buxarlanma hansı temperaturda gedə bilər?','İstənilən temperaturda gedir.',array['İstənilən temperaturda','Yalnız 100 °C-də','Yalnız 0 °C-də','Yalnız qaynayanda'],1),
('fiz8-istilik-qanun#13','fizika','fiz-8-istilik-qanun',3,4,'Buxarlanma sürəti nədən asılıdır?','Temperaturdan, səthin sahəsindən, küləkdən.',array['Temperaturdan, səthdən, küləkdən','Yalnız qabdan','Mayenin rəngindən','Heç nədən'],1),
('fiz8-istilik-qanun#14','fizika','fiz-8-istilik-qanun',3,4,'Tərləmə orqanizmi necə sərinləşdirir?','Tər buxarlanarkən istilik aparır.',array['Buxarlanma istilik aparır','Tər soyuqdur','Dərini yuyur','Sərinləşdirmir'],1),
('fiz8-istilik-qanun#15','fizika','fiz-8-istilik-qanun',3,4,'Su donarkən istilik verir, yoxsa alır?','Donma zamanı istilik ayrılır (verir).',array['İstilik verir','İstilik alır','Heç biri','Gah verir, gah alır'],1),
('fiz8-istilik-qanun#16','fizika','fiz-8-istilik-qanun',2,4,'İstilik mühərriklərinə misal hansıdır?','Avtomobilin daxili yanma mühərriki.',array['Daxili yanma mühərriki','Elektrik lampası','Kompas','Linza'],1),
('fiz8-istilik-qanun#17','fizika','fiz-8-istilik-qanun',3,4,'İstilik mühərrikinin FİƏ-si 100%-dən necə olur?','Həmişə kiçik olur — itkilər var.',array['Kiçik olur','Böyük olur','Bərabər olur','Ölçülmür'],1),
('fiz8-istilik-qanun#18','fizika','fiz-8-istilik-qanun',3,4,'Mühərrik 2000 J enerji alıb 500 J faydalı iş görür. FİƏ neçə faizdir?','FİƏ = 500/2000 · 100 = 25 %.',array['25 %','40 %','50 %','5 %'],1),
('fiz8-istilik-qanun#19','fizika','fiz-8-istilik-qanun',3,4,'Qaynama temperaturu təzyiqdən asılıdırmı?','Bəli — dağlarda su daha aşağı temperaturda qaynayır.',array['Bəli, asılıdır','Xeyr, sabitdir','Yalnız qışda','Yalnız duzlu suda'],1),
('fiz8-istilik-qanun#20','fizika','fiz-8-istilik-qanun',2,4,'İstilik mühərriklərinin ətraf mühitə mənfi təsiri nədir?','Havanı işlənmiş qazlarla çirkləndirir.',array['Havanı qazlarla çirkləndirir','Havanı təmizləyir','Suyu şirinləşdirir','Təsiri yoxdur'],1),
...
('kim8-dovri-cedvel#11','kimya','kim-8-dovri-cedvel',3,1,'Qrupda yuxarıdan aşağı metal xassələri necə dəyişir?','Qrup üzrə aşağı getdikcə güclənir.',array['Güclənir','Zəifləyir','Dəyişmir','İtir'],1),
('kim8-dovri-cedvel#12','kimya','kim-8-dovri-cedvel',3,1,'Xarici təbəqəsində 1 elektron olan I qrup metalları necə adlanır?','Qələvi metallar adlanır.',array['Qələvi metallar','Halogenlər','Təsirsiz qazlar','Yarımmetallar'],1),
('kim8-dovri-cedvel#13','kimya','kim-8-dovri-cedvel',3,1,'VII qrupun fəal qeyri-metalları necə adlanır?','Halogenlər adlanır.',array['Halogenlər','Qələvi metallar','Nəcib qazlar','Lantanoidlər'],1),
('kim8-dovri-cedvel#14','kimya','kim-8-dovri-cedvel',3,1,'Təsirsiz (nəcib) qazlar hansı qrupdadır?','VIII (A) qrupunda yerləşir.',array['VIII qrupda','I qrupda','IV qrupda','II qrupda'],1),
('kim8-dovri-cedvel#15','kimya','kim-8-dovri-cedvel',3,1,'Alüminiumun (sıra nömrəsi 13) elektronları təbəqələr üzrə necə paylanır?','2, 8, 3 şəklində paylanır.',array['2, 8, 3','3, 8, 2','13, 0, 0','2, 11'],1),
('kim8-dovri-cedvel#16','kimya','kim-8-dovri-cedvel',3,1,'Dövri qanunun müasir ifadəsi nəyə əsaslanır?','Nüvə yükünün artmasına.',array['Nüvə yükünün artması','Atom kütləsinə yalnız','Elementin rənginə','Kəşf tarixinə'],1),
('kim8-dovri-cedvel#17','kimya','kim-8-dovri-cedvel',3,1,'Mendeleyev cədvəlində boş buraxdığı yerlər nəyi göstərirdi?','Hələ kəşf olunmamış elementləri.',array['Hələ kəşf olunmamış elementləri','Səhvləri','Metalları','Qazları'],1),
('kim8-dovri-cedvel#18','kimya','kim-8-dovri-cedvel',3,1,'İkinci elektron təbəqəyə ən çoxu neçə elektron sığır?','İkinci təbəqəyə ən çoxu 8 elektron.',array['8','2','18','32'],1),
('kim8-dovri-cedvel#19','kimya','kim-8-dovri-cedvel',3,1,'Elementin valent elektronları harada yerləşir?','Xarici elektron təbəqəsində.',array['Xarici təbəqədə','Nüvədə','Birinci təbəqədə hökmən','Atomdan kənarda'],1),
('kim8-dovri-cedvel#20','kimya','kim-8-dovri-cedvel',3,1,'Kimyəvi xassələri oxşar olan elementlər cədvəldə harada yerləşir?','Eyni qrupda yerləşir.',array['Eyni qrupda','Eyni dövrdə hökmən','Küncdə','Yan-yana həmişə'],1),
...
('kim8-rabite#11','kimya','kim-8-rabite',3,1,'NaCl kristalında hansı hissəciklər yerləşir?','Na⁺ və Cl⁻ ionları.',array['Na⁺ və Cl⁻ ionları','Neytral atomlar','Yalnız elektronlar','Molekullar'],1),
('kim8-rabite#12','kimya','kim-8-rabite',2,1,'Kovalent rabitə hansı növlərə bölünür?','Polyar və qeyri-polyar.',array['Polyar və qeyri-polyar','Bərk və maye','İsti və soyuq','Böyük və kiçik'],1),
('kim8-rabite#13','kimya','kim-8-rabite',3,1,'N₂ molekulunda rabitə neçəqatdır?','Azot molekulunda üçqat rabitə var.',array['Üçqat','Birqat','İkiqat','Dördqat'],1),
('kim8-rabite#14','kimya','kim-8-rabite',3,1,'İon birləşmələri adi şəraitdə hansı halda olur?','Bərk kristal halında.',array['Bərk kristal halında','Qaz halında','Maye halında','Plazma halında'],1),
('kim8-rabite#15','kimya','kim-8-rabite',3,1,'Elektromənfilik dövrdə soldan sağa necə dəyişir?','Dövr üzrə artır.',array['Artır','Azalır','Dəyişmir','Sıfırlanır'],1),
('kim8-rabite#16','kimya','kim-8-rabite',3,1,'Metal parıltısı və keçiricilik hansı rabitə ilə izah olunur?','Metal rabitəsi ilə (sərbəst elektronlar).',array['Metal rabitəsi ilə','İon rabitəsi ilə','Kovalent rabitə ilə','Hidrogen rabitəsi ilə'],1),
('kim8-rabite#17','kimya','kim-8-rabite',3,1,'HCl molekulundakı rabitə hansı növdür?','Fərqli qeyri-metallar — polyar kovalent.',array['Polyar kovalent','Qeyri-polyar kovalent','İon rabitəsi','Metal rabitəsi'],1),
('kim8-rabite#18','kimya','kim-8-rabite',3,1,'İonlar arasında hansı qüvvə təsir edir?','Əks yüklərin elektrostatik cazibəsi.',array['Elektrostatik cazibə','Maqnit qüvvəsi','Sürtünmə','Arximed qüvvəsi'],1),
('kim8-rabite#19','kimya','kim-8-rabite',3,1,'Rabitə yaranarkən atomlar nəyə can atır?','Davamlı 8 elektronlu xarici təbəqəyə.',array['Davamlı xarici təbəqəyə (8 elektrona)','Elektronları itirməyə hamısı','Parçalanmağa','Heç nəyə'],1),
('kim8-rabite#20','kimya','kim-8-rabite',3,1,'Duzların suda məhlulları nəyi keçirir?','İonlar sərbəstləşir — cərəyanı keçirir.',array['Elektrik cərəyanını','İşığı yalnız','Səsi yalnız','Heç nəyi'],1),
...
('kim8-reaksiya-tesnifat#11','kimya','kim-8-reaksiya-tesnifat',3,2,'CaCO₃ = CaO + CO₂ reaksiyası hansı tipə aiddir?','Bir maddədən iki maddə — parçalanma.',array['Parçalanma','Birləşmə','Əvəzetmə','Mübadilə'],1),
('kim8-reaksiya-tesnifat#12','kimya','kim-8-reaksiya-tesnifat',3,2,'Neytrallaşma hansı reaksiya tipinə aiddir?','Turşu və əsas hissələrini dəyişir — mübadilə.',array['Mübadiləyə','Birləşməyə','Parçalanmaya','Əvəzetməyə'],1),
('kim8-reaksiya-tesnifat#13','kimya','kim-8-reaksiya-tesnifat',3,2,'Tənlikdə əmsalların qoyulması hansı qanunu təmin edir?','Kütlənin saxlanması qanununu.',array['Kütlənin saxlanmasını','Om qanununu','Paskal qanununu','Huk qanununu'],1),
('kim8-reaksiya-tesnifat#14','kimya','kim-8-reaksiya-tesnifat',3,2,'2Mg + O₂ = 2MgO reaksiyası hansı tipdir?','İki maddədən bir maddə — birləşmə.',array['Birləşmə','Parçalanma','Mübadilə','Əvəzetmə'],1),
('kim8-reaksiya-tesnifat#15','kimya','kim-8-reaksiya-tesnifat',3,2,'Fe + CuSO₄ = FeSO₄ + Cu hansı reaksiya tipidir?','Sadə maddə mürəkkəbdəki elementi əvəz edir.',array['Əvəzetmə','Birləşmə','Parçalanma','Neytrallaşma'],1),
('kim8-reaksiya-tesnifat#16','kimya','kim-8-reaksiya-tesnifat',2,2,'Tənliyin sol tərəfində hansı maddələr yazılır?','Reaksiyaya daxil olan başlanğıc maddələr.',array['Başlanğıc maddələr','Məhsullar','Katalizatorlar yalnız','İndikatorlar'],1),
('kim8-reaksiya-tesnifat#17','kimya','kim-8-reaksiya-tesnifat',3,2,'Termokimyəvi tənlikdə əlavə olaraq nə göstərilir?','Reaksiyanın istilik effekti.',array['İstilik effekti','Rəng','Qiymət','Tarix'],1),
('kim8-reaksiya-tesnifat#18','kimya','kim-8-reaksiya-tesnifat',3,2,'Fotosintez istilik baxımından hansı reaksiyadır?','Enerji udulur — endotermikdir.',array['Endotermik (enerji udulur)','Ekzotermik','Neytral','Reaksiya deyil'],1),
('kim8-reaksiya-tesnifat#19','kimya','kim-8-reaksiya-tesnifat',2,2,'Yanma istilik effektinə görə hansı reaksiyadır?','İstilik ayrılır — ekzotermikdir.',array['Ekzotermik','Endotermik','İstiliksiz','Qeyri-müəyyən'],1),
('kim8-reaksiya-tesnifat#20','kimya','kim-8-reaksiya-tesnifat',2,2,'H₂ + Cl₂ = 2HCl tənliyində HCl-in əmsalı neçədir?','Əmsal 2-dir.',array['2','1','3','4'],1),
...
('kim8-reaksiya-sureti#11','kimya','kim-8-reaksiya-sureti',2,3,'Qatı turşu duru turşudan necə reaksiya verir?','Qatılıq çox — reaksiya sürətli.',array['Daha sürətli','Daha yavaş','Eyni cür','Reaksiya vermir'],1),
('kim8-reaksiya-sureti#12','kimya','kim-8-reaksiya-sureti',3,3,'Katalizator reaksiyadan sonra nə olur?','Sərf olunmur — dəyişməz qalır.',array['Dəyişməz qalır','Tamamilə sərf olunur','Buxarlanır','Məhsula çevrilir'],1),
('kim8-reaksiya-sureti#13','kimya','kim-8-reaksiya-sureti',3,3,'İnhibitor nədir?','Reaksiyanı ləngidən maddə.',array['Reaksiyanı ləngidən maddə','Sürətləndirən maddə','Rəng verən maddə','İndikator'],1),
('kim8-reaksiya-sureti#14','kimya','kim-8-reaksiya-sureti',2,3,'Dəmirin paslanması sürətinə görə hansı reaksiyadır?','Yavaş gedən reaksiyadır.',array['Yavaş reaksiyadır','Ani reaksiyadır','Partlayışdır','Reaksiya deyil'],1),
('kim8-reaksiya-sureti#15','kimya','kim-8-reaksiya-sureti',2,3,'Partlayış sürətinə görə hansı reaksiyalara aiddir?','Çox sürətli reaksiyalara.',array['Çox sürətli reaksiyalara','Yavaş reaksiyalara','Getməyən reaksiyalara','Fiziki hadisələrə'],1),
('kim8-reaksiya-sureti#16','kimya','kim-8-reaksiya-sureti',3,3,'Temperaturun 10° artması sürəti təqribən necə dəyişir?','2–4 dəfə artırır.',array['2-4 dəfə artırır','Dəyişmir','2 dəfə azaldır','100 dəfə azaldır'],1),
('kim8-reaksiya-sureti#17','kimya','kim-8-reaksiya-sureti',3,3,'Avtomobil tüstü təmizləyicilərində nədən istifadə olunur?','Zərərli qazları çevirən katalizatorlardan.',array['Katalizatorlar','İndikatorlar','Duzlar','Sular'],1),
('kim8-reaksiya-sureti#18','kimya','kim-8-reaksiya-sureti',3,3,'Təzyiq hansı maddələr arasında reaksiyaların sürətinə təsir edir?','Qaz halında olan maddələrdə.',array['Qazlarda','Bərk cisimlərdə yalnız','Metallarda yalnız','Heç birində'],1),
('kim8-reaksiya-sureti#19','kimya','kim-8-reaksiya-sureti',3,3,'Soyuducu qidanı hansı prosesləri ləngitməklə qoruyur?','Kimyəvi və mikrob proseslərini.',array['Kimyəvi və mikrob proseslərini','Fiziki hərəkəti','İşıq şüalarını','Səsi'],1),
('kim8-reaksiya-sureti#20','kimya','kim-8-reaksiya-sureti',2,3,'Odunun xırda doğranması yanma sürətini necə dəyişir?','Səth böyüyür — yanma sürətlənir.',array['Sürətləndirir','Ləngidir','Dəyişmir','Dayandırır'],1),
...
('kim8-oksidlesme#11','kimya','kim-8-oksidlesme',3,3,'Al → Al³⁺ çevrilməsində alüminium neçə elektron verir?','Üç elektron verir.',array['3','1','2','13'],1),
('kim8-oksidlesme#12','kimya','kim-8-oksidlesme',2,3,'Yanma hansı proseslə müşayiət olunur?','Sürətli oksidləşmə ilə.',array['Oksidləşmə ilə','Reduksiya ilə yalnız','Donma ilə','Kondensasiya ilə'],1),
('kim8-oksidlesme#13','kimya','kim-8-oksidlesme',3,3,'MgO birləşməsində maqneziumun oksidləşmə dərəcəsi neçədir?','Oksigen −2 olduğundan maqnezium +2-dir.',array['+2','−2','0','+1'],1),
('kim8-oksidlesme#14','kimya','kim-8-oksidlesme',3,3,'Reduksiya zamanı oksidləşmə dərəcəsi necə dəyişir?','Elektron alındığı üçün azalır.',array['Azalır','Artır','Dəyişmir','Sıfır olur hökmən'],1),
('kim8-oksidlesme#15','kimya','kim-8-oksidlesme',3,3,'Oksidləşmə və reduksiya prosesləri necə gedir?','Həmişə birgə, paralel gedir.',array['Birgə (paralel)','Ayrı-ayrı günlərdə','Yalnız oksidləşmə olur','Təsadüfi'],1),
('kim8-oksidlesme#16','kimya','kim-8-oksidlesme',3,3,'Metallar reaksiyalarda adətən hansı rolda çıxış edir?','Elektron verirlər — reduksiyaedicidirlər.',array['Reduksiyaedici','Oksidləşdirici','İndikator','Katalizator'],1),
('kim8-oksidlesme#17','kimya','kim-8-oksidlesme',3,3,'Fotosintezdə oksidləşmə-reduksiya prosesi gedirmi?','Bəli — mürəkkəb OR prosesidir.',array['Bəli, gedir','Xeyr, getmir','Yalnız gecə','Yalnız qışda'],1),
('kim8-oksidlesme#18','kimya','kim-8-oksidlesme',3,3,'Pas əmələ gələndə dəmir nə ilə birləşir?','Oksigen və su ilə.',array['Oksigenlə (və su ilə)','Azotla','Qızılla','Duzla yalnız'],1),
('kim8-oksidlesme#19','kimya','kim-8-oksidlesme',3,3,'NaCl-da natriumun oksidləşmə dərəcəsi neçədir?','Natrium +1 göstərir.',array['+1','−1','0','+2'],1),
('kim8-oksidlesme#20','kimya','kim-8-oksidlesme',3,3,'Kəsilmiş almanın qaralması hansı prosesin nəticəsidir?','Havada oksidləşmənin.',array['Oksidləşmənin','Reduksiyanın','Donmanın','Buxarlanmanın'],1),
...
('kim8-tursu-esas#11','kimya','kim-8-tursu-esas',3,4,'Turşuların tərkibi hansı hissələrdən ibarətdir?','Hidrogen və turşu qalığından.',array['Hidrogen və turşu qalığı','Metal və oksigen','İki metal','Yalnız oksigen'],1),
('kim8-tursu-esas#12','kimya','kim-8-tursu-esas',2,4,'HNO₃ hansı turşudur?','Nitrat turşusudur.',array['Nitrat turşusu','Sulfat turşusu','Xlorid turşusu','Karbonat turşusu'],1),
('kim8-tursu-esas#13','kimya','kim-8-tursu-esas',3,4,'Ca(OH)₂ hansı maddələr sinfinə aiddir?','Əsaslar sinfinə aiddir.',array['Əsaslar sinfinə','Turşulara','Duzlara','Oksidlərə'],1),
('kim8-tursu-esas#14','kimya','kim-8-tursu-esas',3,4,'Universal indikator nəyi göstərir?','Mühitin pH qiymətini.',array['pH-ın qiymətini','Temperaturu','Sıxlığı','Kütləni'],1),
('kim8-tursu-esas#15','kimya','kim-8-tursu-esas',3,4,'pH 7-dən böyük olan mühit hansıdır?','pH > 7 qələvi mühitdir.',array['Qələvi','Turş','Neytral','Duzsuz'],1),
('kim8-tursu-esas#16','kimya','kim-8-tursu-esas',3,4,'NaOH + HCl reaksiyasının məhsulları hansılardır?','NaCl duzu və su.',array['NaCl + H₂O','Yalnız qaz','NaH + ClOH','Heç nə alınmır'],1),
('kim8-tursu-esas#17','kimya','kim-8-tursu-esas',3,4,'Turşu yağışlarına səbəb nədir?','Havadakı kükürd və azot oksidləri.',array['Havadakı kükürd və azot oksidləri','Təmiz su buxarı','Günəş şüaları','Torpaq tozu'],1),
('kim8-tursu-esas#18','kimya','kim-8-tursu-esas',3,4,'Mədə turşuluğu artanda hansı xassəli preparatlar kömək edir?','Əsas xassəli (turşunu neytrallaşdıran).',array['Əsas xassəli preparatlar','Turşu xassəli','Duz məhlulları hökmən','Şirin şərbətlər'],1),
('kim8-tursu-esas#19','kimya','kim-8-tursu-esas',2,4,'Duzlar hansı reaksiyadan alına bilər?','Turşu ilə əsasın neytrallaşmasından.',array['Turşu ilə əsasın reaksiyasından','Suyun donmasından','İşığın sınmasından','Alınmır'],1),
('kim8-tursu-esas#20','kimya','kim-8-tursu-esas',3,4,'K₂SO₄ hansı maddələr sinfinə aiddir?','Metal + turşu qalığı — duzdur.',array['Duzlara','Turşulara','Əsaslara','Oksidlərə'],1),
...
('bio8-heyat-kimyasi#11','biologiya','bio-8-heyat-kimyasi',2,1,'Orqanizmdə suyun əsas rolu nədir?','Maddələri həll edib daşıyır.',array['Maddələri həll edib daşıyır','Enerji verir yalnız','Skelet qurur','Rəng verir'],1),
('bio8-heyat-kimyasi#12','biologiya','bio-8-heyat-kimyasi',2,1,'Karbohidratlara misal hansılardır?','Qlükoza və nişasta.',array['Qlükoza və nişasta','Hemoqlobin','İnsulin','Kalsium'],1),
('bio8-heyat-kimyasi#13','biologiya','bio-8-heyat-kimyasi',3,1,'DNT hüceyrənin harasında yerləşir?','Əsasən nüvədə yerləşir.',array['Nüvədə','Membranda','Vakuolda','Hüceyrədən kənarda'],1),
('bio8-heyat-kimyasi#14','biologiya','bio-8-heyat-kimyasi',3,1,'Fermentlər reaksiyaları necə dəyişir?','Onları xeyli sürətləndirir.',array['Sürətləndirir','Ləngidir','Dayandırır','Təsir etmir'],1),
('bio8-heyat-kimyasi#15','biologiya','bio-8-heyat-kimyasi',3,1,'A vitamini çatışmazlığı ilk növbədə nəyə təsir edir?','Görmə qabiliyyətinə.',array['Görməyə','Eşitməyə','Dada','Qoxuya'],1),
('bio8-heyat-kimyasi#16','biologiya','bio-8-heyat-kimyasi',2,1,'Mineral maddələrə misal hansılardır?','Kalsium və dəmir.',array['Kalsium və dəmir','Zülal və yağ','Nişasta','Vitamin C'],1),
('bio8-heyat-kimyasi#17','biologiya','bio-8-heyat-kimyasi',2,1,'Kalsium orqanizmdə nə üçün lazımdır?','Sümük və dişlərin möhkəmliyi üçün.',array['Sümüklərin möhkəmliyi üçün','Görmə üçün yalnız','Səs üçün','Yaddaş üçün yalnız'],1),
('bio8-heyat-kimyasi#18','biologiya','bio-8-heyat-kimyasi',3,1,'Zülalların funksiyalarından biri hansıdır?','Tikinti və müdafiə funksiyası.',array['Tikinti və müdafiə','Yalnız enerji','Yalnız daşıma','Funksiyasızdır'],1),
('bio8-heyat-kimyasi#19','biologiya','bio-8-heyat-kimyasi',3,1,'Yağlar orqanizmdə hansı vəzifəni daşıyır?','Ehtiyat enerji və istilik izolyasiyası.',array['Ehtiyat enerji və istilik izolyasiyası','İrsi məlumat daşıyır','Qan yaradır','Sinir impulsu ötürür'],1),
('bio8-heyat-kimyasi#20','biologiya','bio-8-heyat-kimyasi',3,1,'Hemoqlobinin tərkibində hansı element var?','Dəmir elementi var.',array['Dəmir','Qızıl','Civə','Alüminium'],1),
...
('bio8-bitki#11','biologiya','bio-8-bitki',3,1,'Kök hansı əlavə funksiyanı da yerinə yetirə bilər?','Qida toplamaq (yerkökü, çuğundur).',array['Qida toplamaq (yerkökü kimi)','Fotosintez hökmən','Çiçək açmaq','Toxum yaymaq'],1),
('bio8-bitki#12','biologiya','bio-8-bitki',3,1,'Fotosintezin sürəti nədən asılıdır?','İşıqdan və karbon qazından.',array['İşıqdan və karbon qazından','Küləkdən yalnız','Torpağın rəngindən','Ayın fazasından'],1),
('bio8-bitki#13','biologiya','bio-8-bitki',3,1,'Azot gübrələri bitkiyə nə üçün verilir?','Yarpaq və gövdənin böyüməsi üçün.',array['Yarpaq və gövdənin böyüməsinə','Rəng üçün','Dad üçün','Lazım deyil'],1),
('bio8-bitki#14','biologiya','bio-8-bitki',3,1,'Yarpaqda fotosintezi hansı toxuma aparır?','Xlorofilli əsas toxuma.',array['Xlorofilli əsas toxuma','Örtük toxuması yalnız','Mexaniki toxuma','Ötürücü toxuma yalnız'],1),
('bio8-bitki#15','biologiya','bio-8-bitki',3,1,'Bitkidə ehtiyat qida maddələri harada toplanır?','Kökdə, gövdədə, toxumda.',array['Kök, gövdə, toxumda','Yalnız çiçəkdə','Yalnız ləçəkdə','Toplanmır'],1),
('bio8-bitki#16','biologiya','bio-8-bitki',3,1,'Cücərti niyə işığa doğru əyilir?','İşıq böyümə istiqamətini yönləndirir.',array['İşıq böyüməni istiqamətləndirir','Külək əyir','Təsadüfdür','Kök itələyir'],1),
('bio8-bitki#17','biologiya','bio-8-bitki',2,1,'Toxumda rüşeym üçün nə ehtiyatı var?','Ehtiyat qida maddələri.',array['Ehtiyat qida','Su anbarı','Hava balonu','Heç nə'],1),
('bio8-bitki#18','biologiya','bio-8-bitki',1,1,'Otaq bitkilərinə əsas qulluq nədən ibarətdir?','Suvarma və kifayət qədər işıq.',array['Suvarma və işıq','Yalnız musiqi','Qaranlıq','Duz səpmək'],1),
('bio8-bitki#19','biologiya','bio-8-bitki',1,1,'Meyvə ağaclarında çiçəkləmə adətən hansı fəsildə olur?','Yazda çiçəkləyir.',array['Yazda','Qışda','Payızın sonunda','Heç vaxt'],1),
('bio8-bitki#20','biologiya','bio-8-bitki',3,1,'Bitki hüceyrəsində şirə ilə dolu orqanoid hansıdır?','Vakuol hüceyrə şirəsi saxlayır.',array['Vakuol','Nüvə','Mitoxondri','Ribosom'],1),
...
('bio8-qan-dovrani#11','biologiya','bio-8-qan-dovrani',3,2,'Kiçik qan dövranında qaz mübadiləsi harada gedir?','Ağciyərlərdə gedir.',array['Ağciyərlərdə','Beyində','Mədədə','Dəridə'],1),
('bio8-qan-dovrani#12','biologiya','bio-8-qan-dovrani',3,2,'Qan plazması nədir?','Qanın maye hissəsidir.',array['Qanın maye hissəsi','Qan hüceyrəsi','Damar növü','Xəstəlik adı'],1),
('bio8-qan-dovrani#13','biologiya','bio-8-qan-dovrani',3,2,'Arterial qan hansı qazla zəngindir?','Oksigenlə zəngindir.',array['Oksigenlə','Karbon qazı ilə','Azotla','Heliumla'],1),
('bio8-qan-dovrani#14','biologiya','bio-8-qan-dovrani',3,2,'Toxumalardan ürəyə qayıdan qanda hansı qaz çoxdur?','Karbon qazı çoxdur.',array['Karbon qazı','Oksigen','Hidrogen','Ozon'],1),
('bio8-qan-dovrani#15','biologiya','bio-8-qan-dovrani',3,2,'Ürəkdə əvvəlcə hansı hissələr yığılır?','Əvvəl qulaqcıqlar, sonra mədəciklər.',array['Əvvəl qulaqcıqlar, sonra mədəciklər','Əvvəl mədəciklər','Hamısı birdən','Yığılmır'],1),
('bio8-qan-dovrani#16','biologiya','bio-8-qan-dovrani',2,2,'Nəbz nədir?','Arteriya divarlarının ritmik döyünməsi.',array['Arteriya divarlarının döyünməsi','Qanın rəngi','Ürəyin adı','Damarın uzunluğu'],1),
('bio8-qan-dovrani#17','biologiya','bio-8-qan-dovrani',2,2,'Qan təzyiqi hansı cihazla ölçülür?','Tonometrlə ölçülür.',array['Tonometrlə','Termometrlə','Barometrlə','Dinamometrlə'],1),
('bio8-qan-dovrani#18','biologiya','bio-8-qan-dovrani',3,2,'Hansı qan qrupu universal donor sayılır?','I (0) qrup universal donordur.',array['I (0) qrup','IV qrup','III qrup','Heç biri'],1),
('bio8-qan-dovrani#19','biologiya','bio-8-qan-dovrani',2,2,'Güclü qanaxmada ilk tədbir nədir?','Yaraya sıxıcı sarğı qoyulur.',array['Sıxıcı sarğı qoyulur','Su içirilir yalnız','Gözləmək lazımdır','Yara açıq saxlanır'],1),
('bio8-qan-dovrani#20','biologiya','bio-8-qan-dovrani',3,2,'Ürək əzələsi niyə yorulmadan işləyir?','Yığılma ilə boşalma növbələşir.',array['Növbəli yığılma və boşalma','Heç işləmir','Gecə dayanır','Sümükdən olduğu üçün'],1),
...
('bio8-teneffus#11','biologiya','bio-8-teneffus',2,2,'Burun boşluğundakı tükcüklər nə edir?','Havanı tozdan təmizləyir.',array['Havanı tozdan təmizləyir','Səs yaradır','Qoxunu artırır','Heç nə'],1),
('bio8-teneffus#12','biologiya','bio-8-teneffus',3,2,'Qırtlaq hansı funksiyaları yerinə yetirir?','Hava yolu və səsin yaranması.',array['Hava yolu və səs yaranması','Qida həzmi','Qan təmizlənməsi','Görmə'],1),
('bio8-teneffus#13','biologiya','bio-8-teneffus',1,2,'Ağciyərlər harada yerləşir?','Döş qəfəsində yerləşir.',array['Döş qəfəsində','Qarın boşluğunda','Boyunda','Kəllədə'],1),
('bio8-teneffus#14','biologiya','bio-8-teneffus',3,2,'Nəfəsalma zamanı diafraqma nə edir?','Aşağı enib yastılaşır.',array['Aşağı enir, yastılaşır','Yuxarı qalxır','Hərəkət etmir','Yığılıb yox olur'],1),
('bio8-teneffus#15','biologiya','bio-8-teneffus',3,2,'Alveolları hansı damarlar əhatə edir?','Sıx kapilyar şəbəkəsi.',array['Kapilyarlar','Yalnız arteriyalar','Limfa yalnız','Heç nə'],1),
('bio8-teneffus#16','biologiya','bio-8-teneffus',2,2,'Tənəffüsün orqanizm üçün əhəmiyyəti nədir?','Enerji almaq üçün oksigen təmin edir.',array['Enerji üçün oksigen təmin edir','Yalnız səs üçün','Yalnız qoxu üçün','Əhəmiyyətsizdir'],1),
('bio8-teneffus#17','biologiya','bio-8-teneffus',3,2,'Havanın tərkibində oksigen təqribən neçə faizdir?','Təqribən 21%.',array['21%','78%','50%','1%'],1),
('bio8-teneffus#18','biologiya','bio-8-teneffus',3,2,'Öskürək nəyin müdafiə reaksiyasıdır?','Tənəffüs yollarının təmizlənməsi.',array['Tənəffüs yollarının','Mədənin','Ürəyin','Böyrəklərin'],1),
('bio8-teneffus#19','biologiya','bio-8-teneffus',2,2,'Zökəm zamanı nəfəs almaq niyə çətinləşir?','Burnun selikli qişası şişir.',array['Selikli qişa şişir','Ağciyər böyüyür','Qan azalır','Səbəbsiz'],1),
('bio8-teneffus#20','biologiya','bio-8-teneffus',1,2,'Təmiz havada gəzinti tənəffüs sisteminə necə təsir edir?','Müsbət təsir edir, möhkəmləndirir.',array['Müsbət təsir edir','Zərər verir','Təsir etmir','Yalnız qışda zərərlidir'],1),
...
('bio8-hezm#11','biologiya','bio-8-hezm',1,3,'Dişlərin həzmdə funksiyası nədir?','Qidanı xırdalayıb üyütmək.',array['Qidanı xırdalamaq','Dadmaq','Udmaq','Sormaq'],1),
('bio8-hezm#12','biologiya','bio-8-hezm',1,3,'Qida borusu qidanı hansı orqana ötürür?','Mədəyə ötürür.',array['Mədəyə','Ağciyərə','Böyrəyə','Ürəyə'],1),
('bio8-hezm#13','biologiya','bio-8-hezm',3,3,'Qida mədədə təqribən nə qədər qalır?','Bir neçə saat qalır.',array['Bir neçə saat','Bir neçə saniyə','Bir həftə','Bir ay'],1),
('bio8-hezm#14','biologiya','bio-8-hezm',3,3,'Mədə şirəsindəki pepsin fermenti nəyi parçalayır?','Zülalları parçalayır.',array['Zülalları','Suyu','Duzları','Vitaminləri'],1),
('bio8-hezm#15','biologiya','bio-8-hezm',3,3,'Karbohidratların həzmi harada başlayır?','Ağızda — tüpürcək fermentləri ilə.',array['Ağızda (tüpürcəklə)','Mədədə','Yoğun bağırsaqda','Qaraciyərdə'],1),
('bio8-hezm#16','biologiya','bio-8-hezm',3,3,'Öd hansı maddələrin həzminə kömək edir?','Yağların parçalanmasına.',array['Yağların','Zülalların yalnız','Suyun','Mineralların'],1),
('bio8-hezm#17','biologiya','bio-8-hezm',3,3,'Mədəaltı vəzin həzm şirəsi haraya tökülür?','Nazik bağırsağa (onikibarmaq bağırsağa).',array['Nazik bağırsağa','Mədəyə','Qida borusuna','Yoğun bağırsağa'],1),
('bio8-hezm#18','biologiya','bio-8-hezm',2,3,'Sorulmuş qida maddələri qanla hara daşınır?','Bütün orqan və hüceyrələrə.',array['Bütün hüceyrələrə','Yalnız beyinə','Yalnız əzələlərə','Xaric olunur'],1),
('bio8-hezm#19','biologiya','bio-8-hezm',3,3,'Tərəvəzdəki kobud liflər nəyə xidmət edir?','Bağırsağın normal işləməsinə.',array['Bağırsağın işləməsinə','Görmənin itiliyinə','Səsin gurluğuna','Heç nəyə'],1),
('bio8-hezm#20','biologiya','bio-8-hezm',1,3,'Yeməyi yaxşı çeynəmək nə üçün vacibdir?','Həzmi asanlaşdırır.',array['Həzmi asanlaşdırır','Səsi gözəlləşdirir','Yuxunu artırır','Vacib deyil'],1),
...
('bio8-coxalma#11','biologiya','bio-8-coxalma',2,3,'Cinsi hüceyrələr necə adlanır?','Qametlər adlanır.',array['Qametlər','Neyronlar','Eritrositlər','Fermentlər'],1),
('bio8-coxalma#12','biologiya','bio-8-coxalma',3,3,'Qeyri-cinsi çoxalmanın üstünlüyü nədir?','Tez və sadə çoxalma.',array['Sürətli çoxalma','Müxtəliflik yaratması','Heç bir üstünlük','Yalnız gözəllik'],1),
('bio8-coxalma#13','biologiya','bio-8-coxalma',3,3,'Cinsi çoxalma nəslə nə verir?','Əlamətlərin müxtəlifliyini.',array['Əlamətlərin müxtəlifliyini','Tam eynilik','Heç nə','Yalnız sürət'],1),
('bio8-coxalma#14','biologiya','bio-8-coxalma',2,3,'İnsanda hamiləlik təqribən nə qədər davam edir?','Təqribən 9 ay.',array['9 ay','2 ay','24 ay','1 həftə'],1),
('bio8-coxalma#15','biologiya','bio-8-coxalma',3,3,'Sürfə mərhələsi hansı inkişaf tipinə xasdır?','Çevrilmə ilə (metamorfozla) inkişafa.',array['Çevrilmə ilə inkişafa','Birbaşa inkişafa','İnkişafsızlığa','Vegetativ çoxalmaya'],1),
('bio8-coxalma#16','biologiya','bio-8-coxalma',3,3,'Birbaşa inkişafa misal hansıdır?','Məməlilərin balası valideynə oxşayır.',array['Məməlilərin balası','Kəpənəyin tırtılı','Qurbağanın çömçəquyruğu','Milçəyin sürfəsi'],1),
('bio8-coxalma#17','biologiya','bio-8-coxalma',2,3,'Yumurtanın sarısı nə üçündür?','Rüşeymin qida ehtiyatıdır.',array['Rüşeymin qidası','Rəng üçün','Qabıq üçün','Səs üçün'],1),
('bio8-coxalma#18','biologiya','bio-8-coxalma',3,3,'Toyuq yumurtadan cücə neçə günə çıxır?','Təqribən 21 günə.',array['21 günə','3 günə','90 günə','1 ilə'],1),
('bio8-coxalma#19','biologiya','bio-8-coxalma',3,3,'Nəslə qulluq hansı heyvanlarda daha güclüdür?','Quşlarda və məməlilərdə.',array['Quş və məməlilərdə','Balıqlarda hamısında','Həşəratlarda hamısında','Heç birində'],1),
('bio8-coxalma#20','biologiya','bio-8-coxalma',3,3,'Hidra necə çoxalır?','Bədənində tumurcuq əmələ gəlir.',array['Tumurcuqlanma ilə','Yumurta qoymaqla','Bala doğmaqla','Sporla'],1),
...
('bio8-tesnifat#11','biologiya','bio-8-tesnifat',3,4,'Təsnifat vahidləri böyükdən kiçiyə necə düzülür?','Aləmdən növə doğru.',array['Aləm, tip, sinif, cins, növ','Növ, cins, aləm','Sinif, aləm, növ','Qarışıq düzülür'],1),
('bio8-tesnifat#12','biologiya','bio-8-tesnifat',2,4,'Balıqlar hansı mühitdə yaşamağa uyğunlaşıb?','Su mühitinə uyğunlaşıblar.',array['Su mühitinə','Hava mühitinə','Səhraya','Buzlağa yalnız'],1),
('bio8-tesnifat#13','biologiya','bio-8-tesnifat',2,4,'İnsan məməlilər sinfinə aiddirmi?','Bəli — balasını südlə bəsləyir.',array['Bəli, aiddir','Xeyr, quşdur','Xeyr, balıqdır','Sinfi yoxdur'],1),
('bio8-tesnifat#14','biologiya','bio-8-tesnifat',3,4,'İkiadlı elmi adda birinci söz nəyi bildirir?','Cinsin adını bildirir.',array['Cinsi','Növü','Aləmi','Sinfi'],1),
('bio8-tesnifat#15','biologiya','bio-8-tesnifat',1,4,'Sürünənlərə misal hansılardır?','Kərtənkələ və ilan.',array['Kərtənkələ və ilan','Qartal və sərçə','Balina və delfin','Qarışqa və arı'],1),
('bio8-tesnifat#16','biologiya','bio-8-tesnifat',3,4,'Həşəratların bədəni neçə hissədən ibarətdir?','Baş, döş, qarıncıq — 3 hissə.',array['3 (baş, döş, qarıncıq)','2 hissə','5 hissə','Bölünmür'],1),
('bio8-tesnifat#17','biologiya','bio-8-tesnifat',3,4,'İstiqanlılıq quşlara nə imkanı verir?','Soyuq iqlimdə də fəal qalmaq.',array['Hər iqlimdə fəallıq','Uçmamaq','Su altında yaşamaq','Qış yuxusu hökmən'],1),
('bio8-tesnifat#18','biologiya','bio-8-tesnifat',3,4,'Bitkilər aləminə hansı orqanizmlər aiddir?','Fotosintez edən çoxhüceyrəlilər.',array['Fotosintez edən çoxhüceyrəlilər','Bütün canlılar','Yalnız göbələklər','Yalnız yosunsuzlar'],1),
('bio8-tesnifat#19','biologiya','bio-8-tesnifat',3,4,'Viruslar hüceyrə quruluşuna malikdirmi?','Xeyr — hüceyrəsiz formalardır.',array['Xeyr, deyillər','Bəli, malikdirlər','Yalnız qışda','Yalnız suda'],1),
('bio8-tesnifat#20','biologiya','bio-8-tesnifat',3,4,'Balinalar niyə balıq sayılmır?','Ağciyərlə tənəffüs edən məməlidirlər.',array['Ağciyərlə tənəffüs edən məməlidirlər','Çox böyük olduqları üçün','Dənizdə yaşadıqları üçün','Balıq sayılırlar'],1),
...
('bio8-saglamliq#11','biologiya','bio-8-saglamliq',2,4,'İmmuniteti nə gücləndirir?','Düzgün qidalanma, idman, təmiz hava.',array['Düzgün qidalanma və idman','Yuxusuzluq','Fast-fud','Hərəkətsizlik'],1),
('bio8-saglamliq#12','biologiya','bio-8-saglamliq',3,4,'Antibiotiklər hansı törədicilərə qarşı təsirlidir?','Bakteriyalara qarşı.',array['Bakteriyalara','Viruslara','Vitaminlərə','Hormonlara'],1),
('bio8-saglamliq#13','biologiya','bio-8-saglamliq',2,4,'Virus xəstəliyinə misal hansıdır?','Qrip virus xəstəliyidir.',array['Qrip','Sınıq','Yanıq','Sinqa'],1),
('bio8-saglamliq#14','biologiya','bio-8-saglamliq',2,4,'Yoluxucu xəstə ilə təmasda nədən istifadə etməli?','Qoruyucu maskadan.',array['Qoruyucu maska','Gün eynəyi','Əlcəksiz təmas','Heç nə'],1),
('bio8-saglamliq#15','biologiya','bio-8-saglamliq',2,4,'Dərinin təmizliyi nədən qoruyur?','Mikroblardan qoruyur.',array['Mikroblardan','İşıqdan','Səsdən','Soyuqdan yalnız'],1),
('bio8-saglamliq#16','biologiya','bio-8-saglamliq',3,4,'Uzunmüddətli stress nəyə mənfi təsir edir?','Ürəyə və sinir sisteminə.',array['Ürəyə və sinir sisteminə','Yalnız saça','Yalnız dırnağa','Heç nəyə'],1),
('bio8-saglamliq#17','biologiya','bio-8-saglamliq',2,4,'Məktəblinin gündəlik fiziki fəallığı nə qədər olmalıdır?','Ən azı 1 saat hərəkət.',array['Ən azı 1 saat','5 dəqiqə','Lazım deyil','Həftədə bir dəfə'],1),
('bio8-saglamliq#18','biologiya','bio-8-saglamliq',2,4,'Zərərli qida vərdişinə nə aiddir?','Həddindən artıq şirniyyat yemək.',array['Həddindən artıq şirniyyat','Tərəvəz yemək','Su içmək','Səhər yeməyi'],1),
('bio8-saglamliq#19','biologiya','bio-8-saglamliq',2,4,'İlk yardım çantasında nə olmalıdır?','Sarğı, yod, pambıq.',array['Sarğı, yod, pambıq','Konfet','Oyuncaq','Kitablar'],1),
('bio8-saglamliq#20','biologiya','bio-8-saglamliq',3,4,'Peyvəndlər necə vurulur?','Təqvim üzrə müəyyən yaşlarda.',array['Təqvim üzrə müxtəlif yaşlarda','Yalnız qocalıqda','Heç vaxt','Hər gün'],1),
...
('cog8-kesfler#11','cografiya','cog-8-kesfler',3,1,'Böyük coğrafi kəşflər hansı əsrlərdə baş verdi?','XV–XVII əsrlərdə.',array['XV–XVII əsrlərdə','V–VI əsrlərdə','XX əsrdə','Eramızdan əvvəl'],1),
('cog8-kesfler#12','cografiya','cog-8-kesfler',3,1,'Kolumbun ekspedisiyasının flaqman gəmisi hansı idi?','Santa-Mariya gəmisi.',array['Santa-Mariya','Titanik','Avrora','Viktoriya yalnız'],1),
('cog8-kesfler#13','cografiya','cog-8-kesfler',3,1,'Magellan boğazı hansı materikin cənubundadır?','Cənubi Amerikanın cənubunda.',array['Cənubi Amerikanın','Afrikanın','Avstraliyanın','Avropanın'],1),
('cog8-kesfler#14','cografiya','cog-8-kesfler',3,1,'Kəşflərdən sonra Avropaya hansı yeni bitkilər gətirildi?','Kartof, pomidor, kakao.',array['Kartof, pomidor, kakao','Buğda və arpa','Alma və armud','Üzüm'],1),
('cog8-kesfler#15','cografiya','cog-8-kesfler',3,1,'Rus səyyahları əsasən hansı əraziləri tədqiq etmişdilər?','Sibiri və Uzaq Şərqi.',array['Sibir və Uzaq Şərqi','Afrikanı','Avstraliyanı','Antarktidanı yalnız'],1),
('cog8-kesfler#16','cografiya','cog-8-kesfler',3,1,'Coğrafi kəşflərin elmi nəticələrindən biri nədir?','Dünya xəritəsinin dəqiqləşməsi.',array['Dünya xəritəsinin dəqiqləşməsi','Xəritələrin itməsi','Dənizlərin qurudulması','Heç nə'],1),
('cog8-kesfler#17','cografiya','cog-8-kesfler',3,1,'Vasko da Qama Hindistana hansı okeandan keçərək çatdı?','Hind okeanından.',array['Hind okeanından','Sakit okeandan','Şimal Buzlu okeandan','Baykaldan'],1),
('cog8-kesfler#18','cografiya','cog-8-kesfler',3,1,'İlk dünya səyahəti neçə il davam etdi?','1519–1522 — üç il.',array['3 il (1519-1522)','3 ay','30 il','1 həftə'],1),
('cog8-kesfler#19','cografiya','cog-8-kesfler',3,1,'Kəşflərə qədər avropalılar hansı qitələri tanımırdılar?','Amerika və Avstraliyanı.',array['Amerika və Avstraliyanı','Avropanı','Asiyanı','Afrikanın şimalını'],1),
('cog8-kesfler#20','cografiya','cog-8-kesfler',3,1,'Müasir dövrdə Yerin öyrənilməsi hansı vasitələrlə davam edir?','Peyklər və elmi ekspedisiyalarla.',array['Peyklər və ekspedisiyalarla','Yalnız kitablarla','Yalnız xəyalla','Davam etmir'],1),
...
('cog8-xerite#11','cografiya','cog-8-xerite',2,1,'Coğrafi koordinatlar hansı vahidlə ifadə olunur?','Dərəcə ilə ifadə olunur.',array['Dərəcə ilə','Metrlə','Kiloqramla','Saatla'],1),
('cog8-xerite#12','cografiya','cog-8-xerite',2,1,'Mövzu (tematik) xəritələrə misal hansıdır?','İqlim xəritəsi tematik xəritədir.',array['İqlim xəritəsi','Şəkil albomu','Qlobus','Kompas'],1),
('cog8-xerite#13','cografiya','cog-8-xerite',3,1,'Miqyası 1 : 200 000 olan xəritədə 1 sm neçə kilometrə uyğundur?','200 000 sm = 2 km.',array['2 km','20 km','200 km','0,2 km'],1),
('cog8-xerite#14','cografiya','cog-8-xerite',3,1,'Yerin dərəcə toru nədir?','Paralel və meridianların şəbəkəsi.',array['Paralel və meridianlar şəbəkəsi','Balıqçı toru','Yol xəritəsi','Relyef formaları'],1),
('cog8-xerite#15','cografiya','cog-8-xerite',3,1,'«40° şm. enliyi, 50° ş. uzunluğu» — bunlar nədir?','Nöqtənin coğrafi koordinatlarıdır.',array['Coğrafi koordinatlardır','Telefon nömrəsidir','Hündürlükdür','Məsafədir'],1),
('cog8-xerite#16','cografiya','cog-8-xerite',3,1,'Xəritə proyeksiyaları nə üçün lazımdır?','Kürə səthini müstəviyə köçürmək üçün.',array['Kürəni müstəviyə köçürmək üçün','Rəng vermək üçün','Xəritəni bəzəmək üçün','Lazım deyil'],1),
('cog8-xerite#17','cografiya','cog-8-xerite',3,1,'Aerofoto və kosmik şəkillər harada istifadə olunur?','Dəqiq xəritələrin tərtibində.',array['Xəritələrin tərtibində','Yalnız reklamda','Yalnız kinoda','İstifadə olunmur'],1),
('cog8-xerite#18','cografiya','cog-8-xerite',2,1,'Ekvatorun enlik dərəcəsi neçədir?','Ekvator 0° enlikdir.',array['0°','90°','180°','45°'],1),
('cog8-xerite#19','cografiya','cog-8-xerite',2,1,'Qütblərin coğrafi enliyi neçə dərəcədir?','Qütblər 90° enlikdədir.',array['90°','0°','60°','120°'],1),
('cog8-xerite#20','cografiya','cog-8-xerite',2,1,'GPS naviqasiya sistemi nəyi təyin edir?','Yerləşdiyin nöqtənin koordinatlarını.',array['Yerin koordinatlarını','Havanı','Qiymətləri','Vaxtın fəslini'],1),
...
('cog8-yer-hereketi#11','cografiya','cog-8-yer-hereketi',3,2,'Yerin oxu orbit müstəvisinə nəzərən necə yerləşir?','Maili vəziyyətdədir (66,5°).',array['Maili vəziyyətdədir','Perpendikulyar','Üfüqi','Hər gün dəyişir'],1),
('cog8-yer-hereketi#12','cografiya','cog-8-yer-hereketi',3,2,'Gündönümü günləri hansılardır?','22 iyun və 22 dekabr.',array['22 iyun və 22 dekabr','21 mart və 23 sentyabr','1 yanvar və 1 iyul','8 mart və 9 may'],1),
('cog8-yer-hereketi#13','cografiya','cog-8-yer-hereketi',3,2,'Cənub yarımkürəsində yay hansı aylara düşür?','Dekabr–fevral aylarına.',array['Dekabr-fevrala','İyun-avqusta','Mart-maya','Sentyabr-noyabra'],1),
('cog8-yer-hereketi#14','cografiya','cog-8-yer-hereketi',3,2,'Yerli vaxt nədən asılıdır?','Coğrafi uzunluqdan asılıdır.',array['Coğrafi uzunluqdan','Enlikdən yalnız','Hündürlükdən','Fəsildən yalnız'],1),
('cog8-yer-hereketi#15','cografiya','cog-8-yer-hereketi',3,2,'Bir saat qurşağı neçə dərəcə uzunluğu əhatə edir?','360 : 24 = 15 dərəcə.',array['15°','24°','30°','60°'],1),
('cog8-yer-hereketi#16','cografiya','cog-8-yer-hereketi',2,2,'Şimal yarımkürəsində ən qısa gündüz hansı tarixdədir?','22 dekabr — qış gündönümü.',array['22 dekabr','22 iyun','21 mart','1 sentyabr'],1),
('cog8-yer-hereketi#17','cografiya','cog-8-yer-hereketi',3,2,'Günəş şüalarının düşmə bucağı nəyə təsir edir?','Səthin aldığı istiliyin miqdarına.',array['İstiliyin miqdarına','Havanın tərkibinə','Dağların hündürlüyünə','Heç nəyə'],1),
('cog8-yer-hereketi#18','cografiya','cog-8-yer-hereketi',3,2,'Yerin fırlanması küləklərin istiqamətinə təsir edirmi?','Bəli — axınları meyilləndirir.',array['Bəli, meyilləndirir','Xeyr, təsir etmir','Yalnız qışda','Yalnız gecə'],1),
('cog8-yer-hereketi#19','cografiya','cog-8-yer-hereketi',3,2,'Qütb gecəsi harada müşahidə olunur?','Qütb dairələrindən yüksək enliklərdə.',array['Qütb dairələrindən yüksək enliklərdə','Ekvatorda','Tropiklərdə','Hər yerdə'],1),
('cog8-yer-hereketi#20','cografiya','cog-8-yer-hereketi',3,2,'Ekvatorda gecə ilə gündüzün uzunluğu necədir?','İl boyu təqribən bərabərdir.',array['İl boyu bərabərdir','Yayda gündüz 20 saatdır','Qışda gecə olmur','Daim dəyişir kəskin'],1),
...
('cog8-tektonik#11','cografiya','cog-8-tektonik',3,2,'Yer qabığı ilə üst mantiyanın bərk hissəsi birlikdə nəyi təşkil edir?','Litosferi təşkil edir.',array['Litosferi','Atmosferi','Nüvəni','Biosferi'],1),
('cog8-tektonik#12','cografiya','cog-8-tektonik',3,2,'Zəlzələnin gücü hansı şkala ilə qiymətləndirilir?','Rixter şkalası ilə.',array['Rixter şkalası ilə','Bofort şkalası ilə','Selsi şkalası ilə','pH şkalası ilə'],1),
('cog8-tektonik#13','cografiya','cog-8-tektonik',3,2,'Vulkan püskürməsindən əvvəl hansı əlamətlər müşahidə olunur?','Yeraltı təkanlar tezləşir.',array['Yeraltı təkanlar artır','Quşlar oxuyur','Yağış kəsilir','Əlamət olmur'],1),
('cog8-tektonik#14','cografiya','cog-8-tektonik',2,2,'Yanardağ təbiət abidəsi hansı ölkədədir?','Azərbaycandadır (Abşeronda).',array['Azərbaycanda','Yaponiyada','İslandiyada','Çilidə'],1),
('cog8-tektonik#15','cografiya','cog-8-tektonik',3,2,'Seysmik qurşaqlar harada yerləşir?','Litosfer tavalarının sərhədlərində.',array['Tava sərhədlərində','Tavaların mərkəzində','Yalnız okeanda','Yalnız quruda'],1),
('cog8-tektonik#16','cografiya','cog-8-tektonik',3,2,'Tavaların bir-birindən uzaqlaşdığı yerlərdə nə yaranır?','Okean ortası silsilələr, yeni qabıq.',array['Okean ortası dağ silsilələri','Səhralar','Buzlaqlar','Adalar itir'],1),
('cog8-tektonik#17','cografiya','cog-8-tektonik',3,2,'Tektonik hərəkətlərin sübutlarından biri nədir?','Dağlarda dəniz canlılarının qalıqları.',array['Dağlarda dəniz qalıqları','Qumun rəngi','Küləyin səsi','Buludların forması'],1),
('cog8-tektonik#18','cografiya','cog-8-tektonik',3,2,'Sunami nədir?','Sualtı zəlzələnin doğurduğu nəhəng dalğa.',array['Sualtı zəlzələdən yaranan nəhəng dalğa','Güclü külək','Vulkan külü','Buz dağı'],1),
('cog8-tektonik#19','cografiya','cog-8-tektonik',3,2,'Yaponiyada zəlzələlərin tez-tez olmasının səbəbi nədir?','Tava sərhədində yerləşməsi.',array['Tava sərhədində yerləşir','Adalar olması','İqlimi','Əhalisinin çoxluğu'],1),
('cog8-tektonik#20','cografiya','cog-8-tektonik',3,2,'Vulkan külünün torpağa faydası varmı?','Bəli — torpağı münbitləşdirir.',array['Torpağı münbitləşdirir','Heç bir faydası yoxdur','Torpağı zəhərləyir yalnız','Suyu qurudur'],1),
...
('cog8-atmosfer#11','cografiya','cog-8-atmosfer',3,3,'Ozon təbəqəsi atmosferin hansı qatındadır?','Stratosferdə yerləşir.',array['Stratosferdə','Troposferdə','Yer səthində','Kosmosda'],1),
('cog8-atmosfer#12','cografiya','cog-8-atmosfer',3,3,'Orta sutkalıq temperatur necə hesablanır?','Sutka ərzindəki ölçmələrin ortası kimi.',array['Ölçmələrin ortası kimi','Ən yüksək qiymətlə','Ən aşağı qiymətlə','Təxminlə'],1),
('cog8-atmosfer#13','cografiya','cog-8-atmosfer',3,3,'Mütləq maksimum temperatur nədir?','Qeydə alınmış ən yüksək temperatur.',array['Qeydə alınan ən yüksək temperatur','Orta qiymət','Ən aşağı qiymət','Sabit qiymət'],1),
('cog8-atmosfer#14','cografiya','cog-8-atmosfer',3,3,'Briz küləkləri harada əsir?','Dəniz və göl sahillərində.',array['Dəniz sahilində','Səhranın mərkəzində','Yalnız dağ zirvəsində','Meşənin içində'],1),
('cog8-atmosfer#15','cografiya','cog-8-atmosfer',3,3,'Havanın nisbi nəmliyi hansı vahidlə göstərilir?','Faizlə göstərilir.',array['Faizlə','Metrlə','Dərəcə ilə','Kiloqramla'],1),
('cog8-atmosfer#16','cografiya','cog-8-atmosfer',3,3,'Yağıntı əmələ gəlməsi üçün hava necə olmalıdır?','Su buxarı ilə doymuş olmalıdır.',array['Su buxarı ilə doymuş','Tamamilə quru','Çox isti hökmən','Tozsuz'],1),
('cog8-atmosfer#17','cografiya','cog-8-atmosfer',3,3,'Küləyin gücü hansı şkala ilə qiymətləndirilir?','Bofort şkalası ilə.',array['Bofort şkalası ilə','Rixter şkalası ilə','Mendeleyev cədvəli ilə','pH ilə'],1),
('cog8-atmosfer#18','cografiya','cog-8-atmosfer',3,3,'İqlim qurşaqları hansı istiqamətdə bir-birini əvəz edir?','Ekvatordan qütblərə doğru.',array['Ekvatordan qütblərə doğru','Qərbdən şərqə yalnız','Təsadüfi','Əvəz etmir'],1),
('cog8-atmosfer#19','cografiya','cog-8-atmosfer',3,3,'Temperaturu fasiləsiz qeyd edən cihaz hansıdır?','Termoqraf yazır.',array['Termoqraf','Barometr','Flüger','Menzurka'],1),
('cog8-atmosfer#20','cografiya','cog-8-atmosfer',3,3,'Atmosfer olmasaydı Yerdə nə baş verərdi?','Kəskin temperatur fərqləri yaranardı.',array['Kəskin temperatur fərqləri','Heç nə dəyişməzdi','Daha çox yağış yağardı','Küləklər güclənərdi'],1),
...
('cog8-hidrosfer#11','cografiya','cog-8-hidrosfer',3,3,'Dünya okeanının hissələri hansılardır?','Okeanlar, dənizlər, körfəzlər, boğazlar.',array['Okeanlar, dənizlər, körfəzlər, boğazlar','Yalnız çaylar','Göllər və bataqlıqlar','Buzlaqlar yalnız'],1),
('cog8-hidrosfer#12','cografiya','cog-8-hidrosfer',3,3,'Boğaz nədir?','İki su hövzəsini birləşdirən dar su zolağı.',array['İki su hövzəsini birləşdirən dar su zolağı','Dağ keçidi','Çay mənbəyi','Quru sahəsi'],1),
('cog8-hidrosfer#13','cografiya','cog-8-hidrosfer',3,3,'Çaylar hansı mənbələrdən qidalanır?','Yağış, qar və yeraltı sulardan.',array['Yağış, qar, yeraltı sular','Yalnız dənizdən','Yalnız buzlaqdan','Qidalanmır'],1),
('cog8-hidrosfer#14','cografiya','cog-8-hidrosfer',2,3,'Daşqın nə vaxt baş verir?','Çayda suyun səviyyəsi kəskin qalxanda.',array['Çayda su kəskin qalxanda','Quraqlıqda','Qışda hökmən','Su azalanda'],1),
('cog8-hidrosfer#15','cografiya','cog-8-hidrosfer',3,3,'Yeraltı sular necə əmələ gəlir?','Yağıntı sularının torpağa hopması ilə.',array['Suyun torpağa hopması ilə','Vulkanlardan','Küləkdən','Zəlzələdən'],1),
('cog8-hidrosfer#16','cografiya','cog-8-hidrosfer',2,3,'Bulaq nədir?','Yeraltı suyun səthə təbii çıxışı.',array['Yeraltı suyun səthə çıxması','Süni quyu','Dəniz körfəzi','Yağış gölməçəsi'],1),
('cog8-hidrosfer#17','cografiya','cog-8-hidrosfer',3,3,'Göllər mənşəyinə görə hansı növlərə bölünür?','Tektonik, buzlaq, uçqun mənşəli və s.',array['Tektonik, buzlaq, uçqun mənşəli','Şirin və duzlu yalnız','Böyük və kiçik yalnız','Bölünmür'],1),
('cog8-hidrosfer#18','cografiya','cog-8-hidrosfer',3,3,'Bataqlıqlar harada əmələ gəlir?','Rütubətli, alçaq ərazilərdə.',array['Rütubətli alçaq ərazilərdə','Səhralarda','Dağ zirvələrində','Buzlaqların üstündə'],1),
('cog8-hidrosfer#19','cografiya','cog-8-hidrosfer',3,3,'Təbiətdə su dövranı nədir?','Suyun fasiləsiz dövr etməsi.',array['Suyun təbiətdə fasiləsiz dövr etməsi','Suyun itməsi','Suyun yalnız donması','Dənizin quruması'],1),
('cog8-hidrosfer#20','cografiya','cog-8-hidrosfer',3,3,'Xəzərə tökülən ən böyük çay hansıdır?','Volqa çayıdır.',array['Volqa','Nil','Amazon','Dunay'],1),
...
('cog8-olkeler#11','cografiya','cog-8-olkeler',3,4,'Dövlətin əsas atributları hansılardır?','Ərazi, əhali və hakimiyyət.',array['Ərazi, əhali, hakimiyyət','Yalnız bayraq','Yalnız pul','Yalnız ordu'],1),
('cog8-olkeler#12','cografiya','cog-8-olkeler',3,4,'Dünyada təqribən neçə müstəqil dövlət var?','200-ə yaxın dövlət.',array['200-ə yaxın','20','2 000','5 000'],1),
('cog8-olkeler#13','cografiya','cog-8-olkeler',3,4,'Ərazicə ən böyük üç ölkə hansılardır?','Rusiya, Kanada, Çin.',array['Rusiya, Kanada, Çin','Vatikan, Monako, Malta','Azərbaycan, Gürcüstan, İran','İtaliya, İspaniya, Fransa'],1),
('cog8-olkeler#14','cografiya','cog-8-olkeler',3,4,'Əhalinin yaş tərkibi nəyi göstərir?','Uşaq, yetkin və yaşlıların payını.',array['Uşaq, yetkin və yaşlıların payını','Yalnız boyu','Yalnız peşələri','Adları'],1),
('cog8-olkeler#15','cografiya','cog-8-olkeler',3,4,'Ana dili kimi ən çox danışılan dil hansıdır?','Çin dilidir.',array['Çin dili (ana dili kimi)','İsveç dili','Latın dili','Esperanto'],1),
('cog8-olkeler#16','cografiya','cog-8-olkeler',3,4,'Şəhər aqlomerasiyası nədir?','Şəhər və ətraf məntəqələrin birliyi.',array['Şəhər və ətraf qəsəbələrin birliyi','Bir kənd','Dağ silsiləsi','Çay hövzəsi'],1),
('cog8-olkeler#17','cografiya','cog-8-olkeler',3,4,'Azərbaycanın quru sərhədi olan qonşuları hansılardır?','Rusiya, Gürcüstan, Ermənistan, İran, Türkiyə.',array['Rusiya, Gürcüstan, Ermənistan, İran, Türkiyə','Çin və Yaponiya','Fransa və İspaniya','Misir və Liviya'],1),
('cog8-olkeler#18','cografiya','cog-8-olkeler',3,4,'Dövlətlər arasında sərhədlər necə müəyyən olunur?','Beynəlxalq müqavilələrlə.',array['Müqavilələrlə','Futbol oyunu ilə','Səsvermə ilə hökmən','Təsadüfi'],1),
('cog8-olkeler#19','cografiya','cog-8-olkeler',3,4,'Ən sıx məskunlaşmış ölkələrdən biri hansıdır?','Banqladeş çox sıx məskunlaşıb.',array['Banqladeş','Monqolustan','Avstraliya','Kanada'],1),
('cog8-olkeler#20','cografiya','cog-8-olkeler',2,4,'Əhalinin miqrasiyasının əsas səbəblərindən biri nədir?','İş axtarışı.',array['İş axtarışı','Havanın rəngi','Dağların hündürlüyü','Səbəbsiz'],1),
...
('cog8-ekologiya#11','cografiya','cog-8-ekologiya',2,4,'Ekologiya elmi nəyi öyrənir?','Canlılarla mühit arasındakı əlaqələri.',array['Canlılarla mühitin əlaqəsini','Yalnız daşları','Yalnız ulduzları','Yalnız tarixi'],1),
('cog8-ekologiya#12','cografiya','cog-8-ekologiya',3,4,'Ozon deşiklərinin yaranmasına nə səbəb olur?','Freon tipli qazlar.',array['Freon qazlarından','Oksigendən','Yağışdan','Qardan'],1),
('cog8-ekologiya#13','cografiya','cog-8-ekologiya',2,4,'Səs-küy çirklənməsi harada daha güclüdür?','İri şəhərlərdə və magistrallarda.',array['İri şəhərlərdə','Meşədə','Səhrada','Kənddə'],1),
('cog8-ekologiya#14','cografiya','cog-8-ekologiya',3,4,'Zəhərli tullantılar harada saxlanmalıdır?','Xüsusi təchiz olunmuş poliqonlarda.',array['Xüsusi poliqonlarda','Çaylarda','Meşələrdə','Küçələrdə'],1),
('cog8-ekologiya#15','cografiya','cog-8-ekologiya',2,4,'Bərpa olunan enerji mənbələrinə nə aiddir?','Günəş, külək və su enerjisi.',array['Günəş, külək, su','Neft və qaz','Kömür','Uran yalnız'],1),
('cog8-ekologiya#16','cografiya','cog-8-ekologiya',3,4,'Qırmızı kitabın rəngi nəyi simvolizə edir?','Təhlükə siqnalını bildirir.',array['Təhlükə siqnalını','Sevinci','İstiliyi','Bayramı'],1),
('cog8-ekologiya#17','cografiya','cog-8-ekologiya',3,4,'Azərbaycanda qorunan nadir heyvanlardan biri hansıdır?','Ceyran qorunan növdür.',array['Ceyran','Ev pişiyi','Toyuq','Qoyun'],1),
('cog8-ekologiya#18','cografiya','cog-8-ekologiya',2,4,'Meşələrin bərpası üçün nə edilir?','Yeni ağaclar əkilir.',array['Yeni ağaclar əkilir','Meşə yandırılır','Heç nə edilmir','Ağaclar kəsilir'],1),
('cog8-ekologiya#19','cografiya','cog-8-ekologiya',2,4,'Tullantıların çeşidlənməsi nəyə imkan verir?','Onların təkrar emalına.',array['Təkrar emala','Daha çox zibilə','Havanın çirklənməsinə','Heç nəyə'],1),
('cog8-ekologiya#20','cografiya','cog-8-ekologiya',3,4,'Beynəlxalq ekoloji təşkilata misal hansıdır?','Greenpeace (Qrinpis).',array['Qrinpis (Greenpeace)','FIFA','NASA','FBI'],1)
),
ins as (
...
begin
  ...
  if n <> 560 then
    raise exception 'fenn8 suallari: 560 gozlenilirdi, % tapildi', n;
  end if;
